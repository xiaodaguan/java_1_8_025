...
/*      */ {
/*  226 */   private static final PreferencesFactory factory = ;
...
/*      */     {
/*      */ 
/*  233 */       public String run() { return System.getProperty("java.util.prefs.PreferencesFactory"); }
/*      */     });
/*  235 */     if (str != null)
/*      */     {
/*      */ 
...
/*      */ 
/*      */ 
/*  244 */         return (PreferencesFactory)Class.forName(str, false, ClassLoader.getSystemClassLoader()).newInstance();
/*      */       }
...
/*      */ 
/*      */ 
/*  257 */           return (PreferencesFactory)Class.forName(str, false, Thread.currentThread().getContextClassLoader()).newInstance();
/*      */         } catch (Exception localException2) {
/*  259 */           throw new InternalError("Can't instantiate Preferences factory " + str, localException2);
/*      */         }
/*      */       }
/*      */     }
/*      */     
/*      */ 
/*      */ 
/*  266 */     (PreferencesFactory)AccessController.doPrivileged(new PrivilegedAction()
/*      */     {
/*      */       public PreferencesFactory run() {
/*  269 */         return Preferences.access$000();
/*      */       }
/*      */     });
/*      */   }
/*      */   
...
/*      */       try {
/*  281 */         return (PreferencesFactory)localIterator.next();
/*      */       } catch (ServiceConfigurationError localServiceConfigurationError) {}
/*  283 */       if (!(localServiceConfigurationError.getCause() instanceof SecurityException))
/*      */       {
/*      */ 
/*      */ 
/*  287 */         throw localServiceConfigurationError;
/*      */       }
/*      */     }
/*      */     
/*      */ 
...
/*      */     try
/*      */     {
/*  304 */       return (PreferencesFactory)Class.forName(str2, false, Preferences.class.getClassLoader()).newInstance();
/*      */     } catch (Exception localException) {
/*  306 */       throw new InternalError("Can't instantiate platform default Preferences factory " + str2, localException);
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/*  452 */       localSecurityManager.checkPermission(prefsPerm);
/*      */     }
...
/*  468 */       localSecurityManager.checkPermission(prefsPerm);
/*      */     }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/util/prefs/Preferences.class
