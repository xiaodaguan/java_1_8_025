...
/*     */     {
/* 130 */       Thread localThread = Thread.currentThread();
/* 131 */       int i = getState();
/* 132 */       if (i == 0) {
/* 133 */         if (compareAndSetState(0, paramInt)) {
/* 134 */           setExclusiveOwnerThread(localThread);
/* 135 */           return true;
/*     */         }
/*     */       }
/* 138 */       else if (localThread == getExclusiveOwnerThread()) {
/* 139 */         int j = i + paramInt;
/* 140 */         if (j < 0)
...
/*     */     {
/* 190 */       paramObjectInputStream.defaultReadObject();
/* 191 */       setState(0);
/*     */     }
/*     */   }
/*     */   
...
/* 213 */       return nonfairTryAcquire(paramInt);
/*     */     }
/*     */   }
/*     */   
...
/*     */     protected final boolean tryAcquire(int paramInt)
/*     */     {
/* 232 */       Thread localThread = Thread.currentThread();
/* 233 */       int i = getState();
/* 234 */       if (i == 0) {
/* 235 */         if ((!hasQueuedPredecessors()) && 
/* 236 */           (compareAndSetState(0, paramInt))) {
/* 237 */           setExclusiveOwnerThread(localThread);
/* 238 */           return true;
/*     */         }
/*     */       }
/* 241 */       else if (localThread == getExclusiveOwnerThread()) {
/* 242 */         int j = i + paramInt;
/* 243 */         if (j < 0)
...
/*     */   {
/* 757 */     Thread localThread = this.sync.getOwner();
/*     */     
/*     */ 
/* 760 */     return super.toString() + (localThread == null ? "[Unlocked]" : new StringBuilder().append("[Locked by thread ").append(localThread.getName()).append("]").toString());
/*     */   }
/*     */ }


/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/util/concurrent/locks/ReentrantLock.class
