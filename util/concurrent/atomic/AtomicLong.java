...
/*     */     try
/*     */     {
/*  78 */       valueOffset = unsafe.objectFieldOffset(AtomicLong.class.getDeclaredField("value"));
/*  79 */     } catch (Exception localException) { throw new Error(localException);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */     {
/* 235 */       l1 = get();
/* 236 */       l2 = paramLongUnaryOperator.applyAsLong(l1);
/* 237 */     } while (!compareAndSet(l1, l2));
/* 238 */     return l1;
/*     */   }
/*     */   
/*     */ 
...
/*     */     {
/* 254 */       l1 = get();
/* 255 */       l2 = paramLongUnaryOperator.applyAsLong(l1);
/* 256 */     } while (!compareAndSet(l1, l2));
/* 257 */     return l2;
/*     */   }
/*     */   
/*     */ 
...
/*     */     {
/* 278 */       l1 = get();
/* 279 */       l2 = paramLongBinaryOperator.applyAsLong(l1, paramLong);
/* 280 */     } while (!compareAndSet(l1, l2));
/* 281 */     return l1;
/*     */   }
/*     */   
/*     */ 
...
/*     */     {
/* 302 */       l1 = get();
/* 303 */       l2 = paramLongBinaryOperator.applyAsLong(l1, paramLong);
/* 304 */     } while (!compareAndSet(l1, l2));
/* 305 */     return l2;
/*     */   }
/*     */   
/*     */ 
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/util/concurrent/atomic/AtomicLong.class
