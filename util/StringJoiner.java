...
/*     */   {
/* 147 */     this.emptyValue = ((CharSequence)Objects.requireNonNull(paramCharSequence, "The empty value must not be null")).toString();
/* 148 */     return this;
/*     */   }
/*     */   
/*     */ 
...
/*     */ 
/*     */ 
/* 215 */       StringBuilder localStringBuilder = prepareBuilder();
/* 216 */       localStringBuilder.append(paramStringJoiner.value, paramStringJoiner.prefix.length(), i);
/*     */     }
/* 218 */     return this;
/*     */   }
/*     */   
...
/*     */   public int length()
/*     */   {
/* 245 */     return this.value != null ? this.value.length() + this.suffix.length() : this.emptyValue.length();
/*     */   }
/*     */ }


/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/util/StringJoiner.class
