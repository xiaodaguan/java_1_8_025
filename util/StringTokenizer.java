...
/*     */     
/* 150 */     int k = 0;
/* 151 */     int j; for (int m = 0; m < this.delimiters.length(); m += Character.charCount(j)) {
...
/* 167 */         this.delimiterCodePoints[m] = j;m++;
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */     }
/* 248 */     int i = paramInt;
/* 249 */     while ((!this.retDelims) && (i < this.maxPosition)) { int j;
...
/*     */   {
/* 271 */     int i = paramInt;
/* 272 */     int j; while (i < this.maxPosition) {
...
/*     */   {
/* 342 */     this.currentPosition = ((this.newPosition >= 0) && (!this.delimsChanged) ? this.newPosition : skipDelimiters(this.currentPosition));
/*     */     
/*     */ 
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/util/StringTokenizer.class
