...
/* 180 */       do { if (!localListIterator.hasNext()) break;
/* 181 */       } while (localListIterator.next() != null);
...
/* 205 */       do { if (!localListIterator.hasPrevious()) break;
/* 206 */       } while (localListIterator.previous() != null);
...
/* 259 */     for (Object localObject : paramCollection) {
...
/* 391 */     ListItr(int paramInt) { super(null);
/* 392 */       this.cursor = paramInt;
/*     */     }
/*     */     
...
/*     */   {
/* 539 */     int i = 1;
/* 540 */     for (Object localObject : this)
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/util/AbstractList.class
