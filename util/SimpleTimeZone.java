...
/*      */       }
/*      */       
/*  559 */       ??? = paramLong >= -12219292800000L ? gcal : (BaseCalendar)CalendarSystem.forName("julian");
...
/*      */     }
/*      */     
/*  654 */     if ((localDate.getNormalizedYear() != i) || 
/*  655 */       (localDate.getMonth() != j) || 
/*  656 */       (localDate.getDayOfMonth() != paramInt4) || (paramInt5 < 1) || (paramInt5 > 7) || (paramInt6 < 0) || (paramInt6 >= 86400000))
/*      */     {
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */ 
/*  903 */     return (getID().equals(localSimpleTimeZone.getID())) && (hasSameRules(localSimpleTimeZone));
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* 1489 */         this.startDay = (1 + this.startDay / 7);
/*      */       }
/*      */       
/*      */       break;
/*      */     case 4: 
...
/* 1512 */         this.endDay = (1 + this.endDay / 7);
/*      */       }
/*      */       
/*      */       break;
/*      */     case 4: 
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/util/SimpleTimeZone.class
