...
/* 131 */     int j; if (this.bytePixels != null) {
/* 132 */       for (j = 0; j < i; j++) {
...
/* 205 */     int j; if (this.intPixels == null) {
...
/* 301 */     int j; if (this.model == paramColorModel) {
...
/*     */     case 2: 
/*     */     case 3: 
/* 354 */       if ((this.width > 0) && (this.height > 0)) { WritableRaster localWritableRaster;
...
/*     */         }
/*     */         
/* 373 */         Object localObject1 = new BufferedImage(this.model, localWritableRaster, this.model.isAlphaPremultiplied(), null);
/*     */         
...
/* 382 */         Object localObject3; if ((localColorModel instanceof DirectColorModel)) {
/* 383 */           localObject3 = (DataBufferInt)((WritableRaster)localObject2).getDataBuffer();
/* 384 */           this.consumer.setPixels(0, 0, i, j, localColorModel, ((DataBufferInt)localObject3)
/* 385 */             .getData(), 0, i);
/*     */         }
...
/* 389 */           this.consumer.setPixels(0, 0, i, j, localColorModel, ((DataBufferByte)localObject3)
/* 390 */             .getData(), 0, i);
/*     */         }
/*     */         else {
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/image/BufferedImageFilter.class
