...
/*      */       }
/*  427 */     } else { if ((this.colorSpaceType == 6) && ((this.colorSpace instanceof ICC_ColorSpace)))
/*      */       {
/*  429 */         if ((this.colorSpace.getMinValue(0) == 0.0F) && 
/*  430 */           (this.colorSpace.getMaxValue(0) == 1.0F))
/*      */         {
/*      */ 
/*      */ 
...
/*      */             
/*  449 */             this.fromLinearGray16ToOtherGray8LUT = ColorModel.getLinearGray16ToOtherGray8LUT(localICC_ColorSpace);
/*      */           } else {
/*  451 */             this.tosRGB8LUT = ColorModel.getGray16TosRGB8LUT(localICC_ColorSpace);
/*      */             
/*  453 */             this.fromLinearGray16ToOtherGray16LUT = ColorModel.getLinearGray16ToOtherGray16LUT(localICC_ColorSpace);
/*      */           }
/*      */           
/*  456 */           return; } } if (this.needScaleInit)
/*      */       {
/*      */ 
/*      */ 
/*      */ 
...
/*  463 */           if ((this.colorSpace.getMinValue(i) != 0.0F) || 
/*  464 */             (this.colorSpace.getMaxValue(i) != 1.0F)) {
...
/*      */     Object localObject;
/*      */     int j;
/*  515 */     float[] arrayOfFloat1; float[] arrayOfFloat2; switch (this.transferType)
/*      */     {
/*      */     case 0: 
...
/*      */ 
/*      */ 
/*  775 */     return getAlpha(paramInt) << 24 | getRed(paramInt) << 16 | getGreen(paramInt) << 8 | getBlue(paramInt) << 0;
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     Object localObject;
/*  799 */     float f2; int k; switch (this.transferType)
/*      */     {
/*      */ 
/*      */     case 2: 
...
/*  848 */       paramInt2 = 8;
/*  849 */       if (i != 0) {
/*  850 */         j = localObject[this.numColorComponents] & m;
/*      */       }
/*      */       break;
/*      */     case 1: 
...
/*  856 */       if (i != 0) {
/*  857 */         j = arrayOfShort[this.numColorComponents] & m;
/*      */       }
/*      */       break;
/*      */     case 3: 
...
/*  863 */       if (i != 0) {
/*  864 */         j = arrayOfInt[this.numColorComponents];
/*      */       }
/*      */       break;
/*      */     default: 
...
/*  898 */     int i; if (this.is_LinearRGB_stdScale) {
...
/*      */ 
/*      */ 
/* 1133 */       return getAlpha(paramObject) << 24 | getRed(paramObject) << 16 | getGreen(paramObject) << 8 | getBlue(paramObject); }
...
/* 1194 */       initScale();
/*      */     Object localObject1;
/* 1196 */     int m; int i7; if (this.signed) {
/*      */       float f1;
/*      */       float[] arrayOfFloat2;
...
/*      */     } else
/* 1472 */       localObject1 = new int[this.numComponents];
/*      */     float f5;
/*      */     Object localObject2;
...
/* 2055 */     Object localObject2; switch (this.transferType)
/*      */     {
/*      */     case 0: 
...
/*      */     int i2;
/* 2141 */     int i4; int i6; int i8; int i10; switch (this.transferType) {
/*      */     case 0: 
/*      */       byte[] arrayOfByte;
...
/* 2153 */             i2++) {
/* 2154 */           arrayOfByte[n] = ((byte)(int)(arrayOfFloat1[i2] * f1 * ((1 << this.nBits[n]) - 1) + 0.5F));n++;
/*      */         }
/*      */         
...
/* 2163 */             n++) {
/* 2164 */           arrayOfByte[m] = ((byte)(int)(arrayOfFloat1[n] * ((1 << this.nBits[m]) - 1) + 0.5F));m++;
/*      */         }
/*      */       }
/*      */       
...
/* 2180 */             i4++) {
/* 2181 */           arrayOfShort1[i2] = ((short)(int)(arrayOfFloat1[i4] * f2 * ((1 << this.nBits[i2]) - 1) + 0.5F));i2++;
/*      */         }
/*      */         
/*      */ 
...
/* 2191 */             i2++) {
/* 2192 */           arrayOfShort1[i1] = ((short)(int)(arrayOfFloat1[i2] * ((1 << this.nBits[i1]) - 1) + 0.5F));i1++;
/*      */         }
/*      */       }
/*      */       
/*      */ 
...
/* 2209 */             i6++) {
/* 2210 */           arrayOfInt[i4] = ((int)(arrayOfFloat1[i6] * f3 * ((1 << this.nBits[i4]) - 1) + 0.5F));i4++;
/*      */         }
/*      */         
...
/* 2219 */             i4++) {
/* 2220 */           arrayOfInt[i3] = ((int)(arrayOfFloat1[i4] * ((1 << this.nBits[i3]) - 1) + 0.5F));i3++;
/*      */         }
/*      */       }
/*      */       
...
/* 2236 */             i8++) {
/* 2237 */           arrayOfShort2[i6] = ((short)(int)(arrayOfFloat1[i8] * f4 * 32767.0F + 0.5F));i6++;
/*      */         }
/*      */         
...
/* 2243 */             i6++) {
/* 2244 */           arrayOfShort2[i5] = ((short)(int)(arrayOfFloat1[i6] * 32767.0F + 0.5F));i5++;
/*      */         }
/*      */       }
/*      */       
...
/* 2281 */             i12++) {
/* 2282 */           arrayOfDouble[i11] = (paramArrayOfFloat[i12] * d);i11++;
/*      */         }
/* 2284 */         arrayOfDouble[this.numColorComponents] = d;
/*      */       } else {
/* 2286 */         int i9 = 0; for (i10 = paramInt; i9 < this.numComponents; 
/* 2287 */             i10++) {
/* 2288 */           arrayOfDouble[i9] = paramArrayOfFloat[i10];i9++;
/*      */         }
/*      */       }
...
/*      */     int k;
/* 2349 */     int n; int i1; int i2; int i3; switch (this.transferType) {
/*      */     case 0: 
/* 2351 */       byte[] arrayOfByte = (byte[])paramObject;
/* 2352 */       int j = 0; for (k = paramInt; j < this.numComponents; k++) {
/* 2353 */         paramArrayOfFloat[k] = ((arrayOfByte[j] & 0xFF) / ((1 << this.nBits[j]) - 1));j++;
/*      */       }
/*      */       
/* 2356 */       break;
/*      */     case 1: 
...
/* 2360 */         paramArrayOfFloat[n] = ((arrayOfShort1[k] & 0xFFFF) / ((1 << this.nBits[k]) - 1));k++;
/*      */       }
/*      */       
/* 2363 */       break;
/*      */     case 3: 
...
/* 2367 */         paramArrayOfFloat[i1] = (arrayOfInt[n] / ((1 << this.nBits[n]) - 1));n++;
/*      */       }
/*      */       
/* 2370 */       break;
/*      */     case 2: 
...
/*      */     Object localObject1;
/* 2466 */     int i4; int i1; float f1; int i7; int i3; if (paramBoolean) { Object localObject2;
/* 2467 */       float f3; int i5; switch (this.transferType) {
/*      */       case 0: 
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/image/ComponentColorModel.class
