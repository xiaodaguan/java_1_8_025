...
/*     */     {
/* 280 */       throw new IllegalArgumentException(paramString + " mask " + Integer.toHexString(this.maskArray[paramInt2]) + " overflows pixel (expecting " + this.pixel_bits + " bits");
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */     } else {
/* 291 */       this.scaleFactors[paramInt2] = (255.0F / ((1 << j) - 1));
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */       {
/* 427 */         throw new IllegalArgumentException("Noncontiguous color mask (" + Integer.toHexString(paramArrayOfInt[k]) + "at index " + k);
/*     */       }
/*     */     }
/*     */     
/* 431 */     if (paramInt != 0) {
...
/*     */       {
/* 435 */         throw new IllegalArgumentException("Noncontiguous alpha mask (" + Integer.toHexString(paramInt));
/*     */       }
/*     */     }
...
/*     */     {
/* 449 */       throw new IllegalArgumentException("Noncontiguous red mask (" + Integer.toHexString(paramInt1));
/*     */     }
/* 451 */     if (arrayOfInt[1] < 0)
/*     */     {
/* 453 */       throw new IllegalArgumentException("Noncontiguous green mask (" + Integer.toHexString(paramInt2));
/*     */     }
/* 455 */     if (arrayOfInt[2] < 0)
/*     */     {
/* 457 */       throw new IllegalArgumentException("Noncontiguous blue mask (" + Integer.toHexString(paramInt3));
/*     */     }
/* 459 */     if (paramInt4 != 0) {
/* 460 */       arrayOfInt[3] = countBits(paramInt4);
/* 461 */       if (arrayOfInt[3] < 0)
/*     */       {
/* 463 */         throw new IllegalArgumentException("Noncontiguous alpha mask (" + Integer.toHexString(paramInt4));
/*     */       }
/*     */     }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/image/PackedColorModel.class
