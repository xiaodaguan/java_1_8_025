...
/* 374 */       imageComplete(3);
/* 375 */     } else if ((this.intPixels == null) && 
/* 376 */       (this.imageModel == ColorModel.getRGBdefault())) {
...
/* 433 */     int j; if (this.bytePixels != null) {
/* 434 */       for (j = 0; j < i; j++) {
...
/* 505 */     int j; if (this.intPixels == null) {
...
/* 602 */     int j; if (this.imageModel == paramColorModel) {
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/image/PixelGrabber.class
