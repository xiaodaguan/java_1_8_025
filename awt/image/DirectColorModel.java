...
/*      */       {
/*      */ 
/*  253 */         if ((paramColorSpace.getMinValue(i) != 0.0F) || 
/*  254 */           (paramColorSpace.getMaxValue(i) != 1.0F)) {
...
/*      */ 
/*      */ 
/*  458 */       return getAlpha(paramInt) << 24 | getRed(paramInt) << 16 | getGreen(paramInt) << 8 | getBlue(paramInt) << 0;
/*      */     }
...
/*  780 */     float f; int m; Object localObject; if ((this.is_sRGB) || (this.is_LinearRGB))
/*      */     {
/*      */       int n;
...
/*      */     int i2;
/* 1196 */     int i1; int i3; float f1; if (paramBoolean)
/*      */     {
/*      */       int i4;
...
/*      */   {
/* 1414 */     return new String("DirectColorModel: rmask=" + Integer.toHexString(this.red_mask) + " gmask=" + Integer.toHexString(this.green_mask) + " bmask=" + Integer.toHexString(this.blue_mask) + " amask=" + Integer.toHexString(this.alpha_mask));
/*      */   }
/*      */ }


/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/image/DirectColorModel.class
