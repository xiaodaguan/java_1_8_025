...
/* 230 */     for (int i = 0; i < paramInt3; i++) {
/* 231 */       this.offsets[i] = paramInt4;
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* 499 */       return null;
/* 500 */     Object localObject; int[] arrayOfInt; int i; if ((paramObject instanceof short[])) {
/* 501 */       localObject = (short[])paramObject;
/* 502 */       arrayOfInt = new int[localObject.length];
/* 503 */       for (i = 0; i < localObject.length; i++) {
/* 504 */         localObject[i] &= 0xFFFF;
/*     */       }
/* 506 */       return arrayOfInt; }
/* 507 */     if ((paramObject instanceof byte[])) {
/* 508 */       localObject = (byte[])paramObject;
/* 509 */       arrayOfInt = new int[localObject.length];
/* 510 */       for (i = 0; i < localObject.length; i++) {
/* 511 */         arrayOfInt[i] = (0xFF & localObject[i]);
/*     */       }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/image/DataBuffer.class
