...
/*     */     
/*     */ 
/* 337 */     if ((this.length != 1) && (this.length != i) && 
/* 338 */       (this.length != localColorModel1.getNumComponents()))
/*     */     {
...
/*     */ 
/*     */ 
/* 365 */         throw new IllegalArgumentException("Src width (" + k + ") not equal to dst width (" + paramBufferedImage2.getWidth() + ")");
/*     */       }
/* 367 */       if (m != paramBufferedImage2.getHeight())
/*     */       {
/*     */ 
/*     */ 
/* 371 */         throw new IllegalArgumentException("Src height (" + m + ") not equal to dst height (" + paramBufferedImage2.getHeight() + ")");
/*     */       }
/*     */       
/* 374 */       localColorModel2 = paramBufferedImage2.getColorModel();
/*     */       
/* 376 */       if (localColorModel1.getColorSpace().getType() != localColorModel2.getColorSpace().getType()) {
/* 377 */         j = 1;
...
/*     */       int n;
/* 395 */       int i1; if ((localColorModel1.hasAlpha()) && (
...
/*     */         }
/*     */         
/* 404 */         localObject = ((WritableRaster)localObject).createWritableChild(n, i1, ((WritableRaster)localObject)
/* 405 */           .getWidth(), ((WritableRaster)localObject)
/* 406 */           .getHeight(), n, i1, arrayOfInt1);
/*     */       }
/*     */       
/*     */ 
/*     */ 
...
/*     */           }
/*     */           
/* 421 */           localWritableRaster = localWritableRaster.createWritableChild(i1, i2, localWritableRaster
/* 422 */             .getWidth(), localWritableRaster
/* 423 */             .getHeight(), i1, i2, arrayOfInt2);
/*     */         }
/*     */       }
/*     */       
/*     */ 
...
/*     */ 
/*     */ 
/* 485 */         throw new IllegalArgumentException("Number of bands in src " + i + " does not equal number of bands in dest " + paramWritableRaster.getNumBands());
/*     */       }
/*     */     }
/*     */     
...
/*     */       Object localObject;
/* 511 */       LookupOp localLookupOp; if (i2 == 256) {
...
/*     */               }
/*     */             }
/* 571 */             arrayOfInt1[i11] = i8;i11++;
/*     */           }
/*     */           
/*     */ 
/*     */ 
/* 576 */           paramWritableRaster.setPixel(i6, i4, arrayOfInt1);i10++;i5++;
/*     */         }
/* 553 */         i9++;i2++;
/*     */       }
/*     */     }
...
/*     */       
/*     */ 
/* 618 */       localBufferedImage = new BufferedImage(localColorModel, paramBufferedImage.getRaster().createCompatibleWritableRaster(), localColorModel.isAlphaPremultiplied(), null);
/*     */     }
/*     */     else
/*     */     {
...
/*     */       
/*     */ 
/* 626 */       localBufferedImage = new BufferedImage(paramColorModel, paramColorModel.createCompatibleWritableRaster(i, j), paramColorModel.isAlphaPremultiplied(), null);
/*     */     }
/*     */     
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/image/RescaleOp.class
