...
/*     */     }
/*     */     
/* 245 */     return (DataBuffer)localObject;
/*     */   }
/*     */   
...
/* 762 */     if ((this.width == localSinglePixelPackedSampleModel.width) && (this.height == localSinglePixelPackedSampleModel.height) && (this.numBands == localSinglePixelPackedSampleModel.numBands) && (this.dataType == localSinglePixelPackedSampleModel.dataType)) {}
/*     */     
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/* 768 */     return (Arrays.equals(this.bitMasks, localSinglePixelPackedSampleModel.bitMasks)) && (Arrays.equals(this.bitOffsets, localSinglePixelPackedSampleModel.bitOffsets)) && (Arrays.equals(this.bitSizes, localSinglePixelPackedSampleModel.bitSizes)) && (this.maxBitSize == localSinglePixelPackedSampleModel.maxBitSize) && (this.scanlineStride == localSinglePixelPackedSampleModel.scanlineStride);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/image/SinglePixelPackedSampleModel.class
