...
/* 135 */     if ((j != 1) && 
/* 136 */       (j != localColorModel1.getNumComponents()) && 
/* 137 */       (j != localColorModel1.getNumColorComponents()))
/*     */     {
...
/*     */ 
/*     */ 
/* 161 */         throw new IllegalArgumentException("Src width (" + m + ") not equal to dst width (" + paramBufferedImage2.getWidth() + ")");
/*     */       }
/* 163 */       if (n != paramBufferedImage2.getHeight())
/*     */       {
/*     */ 
/*     */ 
/* 167 */         throw new IllegalArgumentException("Src height (" + n + ") not equal to dst height (" + paramBufferedImage2.getHeight() + ")");
/*     */       }
/*     */       
/* 170 */       localColorModel2 = paramBufferedImage2.getColorModel();
/*     */       
/* 172 */       if (localColorModel1.getColorSpace().getType() != localColorModel2.getColorSpace().getType())
/*     */       {
/* 174 */         k = 1;
...
/*     */       int i1;
/* 187 */       int i2; if ((localColorModel1.hasAlpha()) && (
/* 188 */         (i - 1 == j) || (j == 1))) {
...
/*     */         }
/*     */         
/* 196 */         localObject = ((WritableRaster)localObject).createWritableChild(i1, i2, ((WritableRaster)localObject)
/* 197 */           .getWidth(), ((WritableRaster)localObject)
/* 198 */           .getHeight(), i1, i2, arrayOfInt1);
/*     */       }
/*     */       
/*     */ 
/*     */ 
...
/*     */           }
/*     */           
/* 213 */           localWritableRaster = localWritableRaster.createWritableChild(i2, i3, localWritableRaster
/* 214 */             .getWidth(), localWritableRaster
/* 215 */             .getHeight(), i2, i3, arrayOfInt2);
/*     */         }
/*     */       }
/*     */       
/*     */ 
...
/*     */           
/*     */ 
/* 320 */           paramWritableRaster.setPixel(i7, i4, arrayOfInt);i8++;i6++;
/*     */         }
/* 309 */         i5++;i2++;
/*     */       }
/*     */     }
...
/* 365 */     int k = 0;
/* 366 */     BufferedImage localBufferedImage; if (paramColorModel == null) {
...
/*     */ 
/*     */ 
/* 420 */       localBufferedImage = new BufferedImage((ColorModel)localObject, ((ColorModel)localObject).createCompatibleWritableRaster(i, j), ((ColorModel)localObject).isAlphaPremultiplied(), null);
/*     */ 
/*     */ 
/*     */     }
/*     */     else
/*     */     {
/*     */ 
/* 427 */       localBufferedImage = new BufferedImage(paramColorModel, paramColorModel.createCompatibleWritableRaster(i, j), paramColorModel.isAlphaPremultiplied(), null);
/*     */     }
/*     */     
/*     */ 
...
/*     */         }
/*     */         
/* 517 */         paramWritableRaster.setSamples(0, n, paramInt1, 1, i1, arrayOfInt);i1++;
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */         }
/*     */         
/* 563 */         paramWritableRaster.setSamples(0, i1, paramInt1, 1, i, arrayOfInt);i++;
/*     */       }
/*     */     }
/*     */   }
/*     */ }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/image/LookupOp.class
