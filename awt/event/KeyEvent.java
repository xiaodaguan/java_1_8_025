...
/*  935 */         return paramAnonymousKeyEvent.originalSource;
/*      */       }
/*      */     });
/*      */   }
/*      */   
...
/*      */     }
/*      */     
/* 1196 */     switch (paramInt) {
/* 1197 */     case 10:  return Toolkit.getProperty("AWT.enter", "Enter");
...
/* 1355 */       str = Toolkit.getProperty("AWT.numpad", "NumPad");
...
/*      */   {
/* 1384 */     StringBuilder localStringBuilder = new StringBuilder();
/* 1385 */     if ((paramInt & 0x4) != 0) {
/* 1386 */       localStringBuilder.append(Toolkit.getProperty("AWT.meta", "Meta"));
/* 1387 */       localStringBuilder.append("+");
/*      */     }
/* 1389 */     if ((paramInt & 0x2) != 0) {
/* 1390 */       localStringBuilder.append(Toolkit.getProperty("AWT.control", "Ctrl"));
/* 1391 */       localStringBuilder.append("+");
/*      */     }
/* 1393 */     if ((paramInt & 0x8) != 0) {
/* 1394 */       localStringBuilder.append(Toolkit.getProperty("AWT.alt", "Alt"));
/* 1395 */       localStringBuilder.append("+");
/*      */     }
/* 1397 */     if ((paramInt & 0x1) != 0) {
/* 1398 */       localStringBuilder.append(Toolkit.getProperty("AWT.shift", "Shift"));
/* 1399 */       localStringBuilder.append("+");
/*      */     }
/* 1401 */     if ((paramInt & 0x20) != 0) {
/* 1402 */       localStringBuilder.append(Toolkit.getProperty("AWT.altGraph", "Alt Graph"));
/* 1403 */       localStringBuilder.append("+");
/*      */     }
/* 1405 */     if ((paramInt & 0x10) != 0) {
/* 1406 */       localStringBuilder.append(Toolkit.getProperty("AWT.button1", "Button1"));
/* 1407 */       localStringBuilder.append("+");
/*      */     }
/* 1409 */     if (localStringBuilder.length() > 0) {
/* 1410 */       localStringBuilder.setLength(localStringBuilder.length() - 1);
/*      */     }
/* 1412 */     return localStringBuilder.toString();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1518 */     StringBuilder localStringBuilder = new StringBuilder(100);
/*      */     
/* 1520 */     switch (this.id) {
/*      */     case 401: 
/* 1522 */       localStringBuilder.append("KEY_PRESSED");
/* 1523 */       break;
/*      */     case 402: 
/* 1525 */       localStringBuilder.append("KEY_RELEASED");
/* 1526 */       break;
/*      */     case 400: 
/* 1528 */       localStringBuilder.append("KEY_TYPED");
/* 1529 */       break;
/*      */     default: 
/* 1531 */       localStringBuilder.append("unknown type");
/*      */     }
/*      */     
/*      */     
/* 1535 */     localStringBuilder.append(",keyCode=").append(this.keyCode);
/* 1536 */     localStringBuilder.append(",keyText=").append(getKeyText(this.keyCode));
/*      */     
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/* 1542 */     localStringBuilder.append(",keyChar=");
/* 1543 */     switch (this.keyChar) {
/*      */     case '\b': 
/* 1545 */       localStringBuilder.append(getKeyText(8));
/* 1546 */       break;
/*      */     case '\t': 
/* 1548 */       localStringBuilder.append(getKeyText(9));
/* 1549 */       break;
/*      */     case '\n': 
/* 1551 */       localStringBuilder.append(getKeyText(10));
/* 1552 */       break;
/*      */     case '\030': 
/* 1554 */       localStringBuilder.append(getKeyText(3));
/* 1555 */       break;
/*      */     case '\033': 
/* 1557 */       localStringBuilder.append(getKeyText(27));
/* 1558 */       break;
/*      */     case '': 
/* 1560 */       localStringBuilder.append(getKeyText(127));
/* 1561 */       break;
/*      */     case '￿': 
/* 1563 */       localStringBuilder.append(Toolkit.getProperty("AWT.undefined", "Undefined"));
/* 1564 */       localStringBuilder.append(" keyChar");
/* 1565 */       break;
/*      */     default: 
/* 1567 */       localStringBuilder.append("'").append(this.keyChar).append("'");
/*      */     }
/*      */     
/*      */     
/* 1571 */     if (getModifiers() != 0) {
/* 1572 */       localStringBuilder.append(",modifiers=").append(getKeyModifiersText(this.modifiers));
/*      */     }
/* 1574 */     if (getModifiersEx() != 0) {
/* 1575 */       localStringBuilder.append(",extModifiers=").append(getModifiersExText(this.modifiers));
/*      */     }
/*      */     
/* 1578 */     localStringBuilder.append(",keyLocation=");
/* 1579 */     switch (this.keyLocation) {
/*      */     case 0: 
/* 1581 */       localStringBuilder.append("KEY_LOCATION_UNKNOWN");
/* 1582 */       break;
/*      */     case 1: 
/* 1584 */       localStringBuilder.append("KEY_LOCATION_STANDARD");
/* 1585 */       break;
/*      */     case 2: 
/* 1587 */       localStringBuilder.append("KEY_LOCATION_LEFT");
/* 1588 */       break;
/*      */     case 3: 
/* 1590 */       localStringBuilder.append("KEY_LOCATION_RIGHT");
/* 1591 */       break;
/*      */     case 4: 
/* 1593 */       localStringBuilder.append("KEY_LOCATION_NUMPAD");
/* 1594 */       break;
/*      */     default: 
/* 1596 */       localStringBuilder.append("KEY_LOCATION_UNKNOWN");
/*      */     }
/*      */     
/* 1599 */     localStringBuilder.append(",rawCode=").append(this.rawCode);
/* 1600 */     localStringBuilder.append(",primaryLevelUnicode=").append(this.primaryLevelUnicode);
/* 1601 */     localStringBuilder.append(",scancode=").append(this.scancode);
/* 1602 */     localStringBuilder.append(",extendedKeyCode=0x").append(Long.toHexString(this.extendedKeyCode));
/*      */     
/* 1604 */     return localStringBuilder.toString();
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/event/KeyEvent.class
