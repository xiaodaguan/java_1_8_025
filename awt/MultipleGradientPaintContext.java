...
/*     */   
/*     */ 
/* 121 */   private static final int[] SRGBtoLinearRGB = new int['Ā'];
/* 122 */   private static final int[] LinearRGBtoSRGB = new int['Ā'];
...
/*     */ 
/*     */ 
/* 210 */     int[] arrayOfInt = paramMultipleGradientPaint.gradient != null ? (int[])paramMultipleGradientPaint.gradient.get() : null;
/*     */     
/* 212 */     int[][] arrayOfInt1 = paramMultipleGradientPaint.gradients != null ? (int[][])paramMultipleGradientPaint.gradients.get() : (int[][])null;
/*     */     
...
/*     */     {
/*     */ 
/* 419 */       this.gradients[k] = new int['Ā'];
/*     */       
/*     */ 
...
/*     */         {
/* 440 */           this.gradients[k][m] = convertEntireColorLinearRGBtoSRGB(this.gradients[k][m]);
/*     */         }
/*     */       }
/*     */     }
/*     */   }
...
/* 628 */     if ((localRaster == null) || 
/* 629 */       (localRaster.getWidth() < paramInt3) || (localRaster.getHeight() < paramInt4))
/*     */     {
...
/*     */     
/* 646 */     int j = ((SinglePixelPackedSampleModel)localRaster.getSampleModel()).getScanlineStride();
...
/* 669 */       if ((localRaster != null) && 
/* 670 */         (localRaster.getWidth() >= paramInt1) && 
/* 671 */         (localRaster.getHeight() >= paramInt2))
/*     */       {
/* 673 */         cached = null;
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/MultipleGradientPaintContext.class
