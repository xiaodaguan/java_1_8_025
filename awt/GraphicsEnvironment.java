...
/*     */     }
/*     */     
/* 124 */     return (GraphicsEnvironment)localObject;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 174 */               if ((str2.contains("OS X")) && ("sun.awt.HToolkit".equals(
/* 175 */                 System.getProperty("awt.toolkit"))))
/*     */               {
/* 177 */                 GraphicsEnvironment.access$002(GraphicsEnvironment.access$102(Boolean.TRUE));
/*     */               } else {
/* 179 */                 GraphicsEnvironment.access$002(GraphicsEnvironment.access$102(
/* 180 */                   Boolean.valueOf((("Linux".equals(str2)) || 
/* 181 */                   ("SunOS".equals(str2)) || 
/* 182 */                   ("FreeBSD".equals(str2)) || 
/* 183 */                   ("NetBSD".equals(str2)) || 
/* 184 */                   ("OpenBSD".equals(str2))) && 
...
/*     */     throws HeadlessException
/*     */   {
/* 433 */     Rectangle localRectangle = SunGraphicsEnvironment.getUsableBounds(getDefaultScreenDevice());
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/GraphicsEnvironment.class
