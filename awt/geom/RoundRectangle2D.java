...
/*     */ 
/*     */ 
/* 614 */     return (contains(paramDouble1, paramDouble2)) && (contains(paramDouble1 + paramDouble3, paramDouble2)) && (contains(paramDouble1, paramDouble2 + paramDouble4)) && (contains(paramDouble1 + paramDouble3, paramDouble2 + paramDouble4));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 677 */       return (getX() == localRoundRectangle2D.getX()) && (getY() == localRoundRectangle2D.getY()) && (getWidth() == localRoundRectangle2D.getWidth()) && (getHeight() == localRoundRectangle2D.getHeight()) && (getArcWidth() == localRoundRectangle2D.getArcWidth()) && (getArcHeight() == localRoundRectangle2D.getArcHeight());
/*     */     }
/* 679 */     return false;
/*     */   }
/*     */ }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/geom/RoundRectangle2D.class
