...
/* 1211 */       if ((solveQuadratic(arrayOfDouble1, arrayOfDouble2) == 2) && 
/* 1212 */         (evalQuadratic(arrayOfDouble2, 2, true, true, null, d1, d5, d3) == 2)) {}
/*      */       
/* 1214 */       return getTag(arrayOfDouble2[0], paramDouble1, paramDouble1 + paramDouble3) * getTag(arrayOfDouble2[1], paramDouble1, paramDouble1 + paramDouble3) <= 0;
/*      */     }
/*      */     
/*      */ 
/* 1218 */     if (i2 == 0)
...
/* 1225 */       if ((solveQuadratic(arrayOfDouble1, arrayOfDouble2) == 2) && 
/* 1226 */         (evalQuadratic(arrayOfDouble2, 2, true, true, null, d2, d6, d4) == 2)) {}
/*      */       
/* 1228 */       return getTag(arrayOfDouble2[0], paramDouble2, paramDouble2 + paramDouble4) * getTag(arrayOfDouble2[1], paramDouble2, paramDouble2 + paramDouble4) <= 0;
/*      */     }
/*      */     
/*      */ 
/*      */ 
...
/*      */ 
/*      */ 
/* 1325 */     return (contains(paramDouble1, paramDouble2)) && (contains(paramDouble1 + paramDouble3, paramDouble2)) && (contains(paramDouble1 + paramDouble3, paramDouble2 + paramDouble4)) && (contains(paramDouble1, paramDouble2 + paramDouble4));
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* 1398 */       throw new InternalError(localCloneNotSupportedException);
/*      */     }
/*      */   }
/*      */ }


/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/geom/QuadCurve2D.class
