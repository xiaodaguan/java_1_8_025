...
/* 266 */       return (Rectangle2D)localObject;
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/* 281 */       return (Rectangle2D)localObject;
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/* 663 */     double d1 = getX();
/* 664 */     double d2 = getY();
/* 665 */     if ((paramDouble1 >= d1) && (paramDouble2 >= d2)) {}
/*     */     
/*     */ 
/* 668 */     return (paramDouble1 < d1 + getWidth()) && (paramDouble2 < d2 + getHeight());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 679 */     double d1 = getX();
/* 680 */     double d2 = getY();
/* 681 */     if ((paramDouble1 + paramDouble3 > d1) && (paramDouble2 + paramDouble4 > d2)) {}
/*     */     
/*     */ 
/* 684 */     return (paramDouble1 < d1 + getWidth()) && (paramDouble2 < d2 + getHeight());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 695 */     double d1 = getX();
/* 696 */     double d2 = getY();
/* 697 */     if ((paramDouble1 >= d1) && (paramDouble2 >= d2)) {}
/*     */     
/*     */ 
/* 700 */     return (paramDouble1 + paramDouble3 <= d1 + getWidth()) && (paramDouble2 + paramDouble4 <= d2 + getHeight());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 926 */       return (getX() == localRectangle2D.getX()) && (getY() == localRectangle2D.getY()) && (getWidth() == localRectangle2D.getWidth()) && (getHeight() == localRectangle2D.getHeight());
/*     */     }
/* 928 */     return false;
/*     */   }
/*     */ }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/geom/Rectangle2D.class
