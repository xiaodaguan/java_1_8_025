...
/*     */   {
/* 402 */     return (contains(paramDouble1, paramDouble2)) && (contains(paramDouble1 + paramDouble3, paramDouble2)) && (contains(paramDouble1, paramDouble2 + paramDouble4)) && (contains(paramDouble1 + paramDouble3, paramDouble2 + paramDouble4));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 460 */       return (getX() == localEllipse2D.getX()) && (getY() == localEllipse2D.getY()) && (getWidth() == localEllipse2D.getWidth()) && (getHeight() == localEllipse2D.getHeight());
/*     */     }
/* 462 */     return false;
/*     */   }
/*     */ }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/geom/Ellipse2D.class
