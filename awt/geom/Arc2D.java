...
/*      */     
/* 1229 */     boolean bool2 = Line2D.relativeCCW(d8, d9, d10, d11, 2.0D * d2, 2.0D * d4) * Line2D.relativeCCW(d8, d9, d10, d11, 0.0D, 0.0D) >= 0;
...
/* 1292 */       if ((d12 >= d8) || (d14 >= d8) || (d10 >= d8) || (d6 <= paramDouble1) || 
/* 1293 */         (!containsAngle(0.0D))) { if ((d12 > paramDouble1) && (d14 > paramDouble1) && (d10 > paramDouble1) && (d4 < d8))
/*      */         {
/* 1295 */           if (!containsAngle(180.0D)) {} }
/* 1296 */       } else { return true;
/*      */       }
/*      */     }
/* 1299 */     if ((d10 >= paramDouble1) && (d10 <= d8)) {
/* 1300 */       if ((d13 <= paramDouble2) || (d15 <= paramDouble2) || (d11 <= paramDouble2) || (d5 >= d9) || 
/* 1301 */         (!containsAngle(90.0D))) { if ((d13 < d9) && (d15 < d9) && (d11 < d9) && (d7 > paramDouble2))
/*      */         {
/* 1303 */           if (!containsAngle(270.0D)) {} }
...
/*      */     {
/* 1318 */       if ((localDouble.intersectsLine(d10, d11, d12, d13)) || 
/* 1319 */         (localDouble.intersectsLine(d10, d11, d14, d15))) {
/* 1320 */         return true;
/*      */       }
/*      */       
/*      */     }
...
/*      */ 
/*      */ 
/* 1470 */       return (getX() == localArc2D.getX()) && (getY() == localArc2D.getY()) && (getWidth() == localArc2D.getWidth()) && (getHeight() == localArc2D.getHeight()) && (getAngleStart() == localArc2D.getAngleStart()) && (getAngleExtent() == localArc2D.getAngleExtent()) && (getArcType() == localArc2D.getArcType());
/*      */     }
/* 1472 */     return false;
/*      */   }
/*      */ }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/geom/Arc2D.class
