...
/*     */     }
/*  77 */     (PrinterJob)AccessController.doPrivileged(new PrivilegedAction()
/*     */     {
/*     */       public Object run() {
...
/*     */   {
/* 108 */     return PrintServiceLookup.lookupPrintServices(DocFlavor.SERVICE_FORMATTED.PAGEABLE, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/* 424 */     MediaPrintableArea localMediaPrintableArea = (MediaPrintableArea)paramPrintRequestAttributeSet.get(MediaPrintableArea.class);
/*     */     
/* 426 */     OrientationRequested localOrientationRequested = (OrientationRequested)paramPrintRequestAttributeSet.get(OrientationRequested.class);
/*     */     
...
/*     */     Object localObject;
/*     */     
/* 436 */     if ((localMediaPrintableArea == null) && (localMedia != null) && 
/* 437 */       (localPrintService.isAttributeCategorySupported(MediaPrintableArea.class)))
/*     */     {
/* 439 */       localObject = localPrintService.getSupportedAttributeValues(MediaPrintableArea.class, null, paramPrintRequestAttributeSet);
/*     */       
...
/*     */     }
/*     */     
/* 447 */     if ((localMedia != null) && 
/* 448 */       (localPrintService.isAttributeValueSupported(localMedia, null, paramPrintRequestAttributeSet)) && 
/* 449 */       ((localMedia instanceof MediaSizeName))) {
...
/*     */ 
/*     */ 
/* 466 */     if ((localMediaPrintableArea != null) && 
/* 467 */       (localPrintService.isAttributeValueSupported(localMediaPrintableArea, null, paramPrintRequestAttributeSet)))
/*     */     {
/* 469 */       localObject = localMediaPrintableArea.getPrintableArea(25400);
...
/*     */     
/*     */ 
/* 477 */     if ((localOrientationRequested != null) && 
/* 478 */       (localPrintService.isAttributeValueSupported(localOrientationRequested, null, paramPrintRequestAttributeSet))) {
/*     */       int i;
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/print/PrinterJob.class
