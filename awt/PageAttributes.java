...
/*  972 */       throw new InternalError(localCloneNotSupportedException);
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/* 1058 */     if ((str != null) && (
/* 1059 */       (str.equals(Locale.US.getCountry())) || 
/* 1060 */       (str.equals(Locale.CANADA.getCountry())))) {
...
/*      */   public int hashCode()
/*      */   {
/* 1359 */     return this.color.hashCode() << 31 ^ this.media.hashCode() << 24 ^ this.orientationRequested.hashCode() << 23 ^ this.origin.hashCode() << 22 ^ this.printQuality.hashCode() << 20 ^ this.printerResolution[2] >> 2 << 19 ^ this.printerResolution[1] << 10 ^ this.printerResolution[0];
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1374 */     return "color=" + getColor() + ",media=" + getMedia() + ",orientation-requested=" + getOrientationRequested() + ",origin=" + getOrigin() + ",print-quality=" + getPrintQuality() + ",printer-resolution=[" + this.printerResolution[0] + "," + this.printerResolution[1] + "," + this.printerResolution[2] + "]";
/*      */   }
/*      */ }


/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/PageAttributes.class
