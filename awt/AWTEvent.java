...
/*     */     {
/* 290 */       inputEvent_CanAccessSystemClipboard_Field = (Field)AccessController.doPrivileged(new PrivilegedAction()
/*     */       {
/*     */         public Field run() {
/* 293 */           Field localField = null;
/*     */           try
/*     */           {
/* 296 */             localField = InputEvent.class.getDeclaredField("canAccessSystemClipboard");
...
/*     */ 
/*     */ 
/* 484 */       return new Event(localObject1, localKeyEvent.getWhen(), i, 0, 0, Event.getOldEventKey(localKeyEvent), localKeyEvent.getModifiers() & 0xFFFFFFEF);
/*     */     
/*     */     case 501: 
/*     */     case 502: 
/*     */     case 503: 
...
/*     */ 
/*     */ 
/* 496 */       Event localEvent = new Event(localObject1, localMouseEvent.getWhen(), i, localMouseEvent.getX(), localMouseEvent.getY(), 0, localMouseEvent.getModifiers() & 0xFFFFFFEF);
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/AWTEvent.class
