...
/*     */   double dx;
/*     */   
/*  47 */   static synchronized Raster getCachedRaster(ColorModel paramColorModel, int paramInt1, int paramInt2) { if ((paramColorModel == cachedModel) && 
/*  48 */       (cached != null)) {
/*  49 */       Raster localRaster = (Raster)cached.get();
/*  50 */       if ((localRaster != null) && 
/*  51 */         (localRaster.getWidth() >= paramInt1) && 
/*  52 */         (localRaster.getHeight() >= paramInt2))
/*     */       {
/*  54 */         cached = null;
...
/* 175 */         if (((i7 == 0) || (i7 == 255)) && 
/* 176 */           (localDirectColorModel.getRedMask() == 255) && 
/* 177 */           (localDirectColorModel.getGreenMask() == 65280) && 
/* 178 */           (localDirectColorModel.getBlueMask() == 16711680))
/*     */         {
...
/*     */     }
/* 188 */     this.interp = new int[paramBoolean ? 'ȁ' : 'ā'];
...
/* 256 */     for (;;) { paramInt4--; if (paramInt4 < 0) break;
/* 257 */       int m = i;
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/GradientPaintContext.class
