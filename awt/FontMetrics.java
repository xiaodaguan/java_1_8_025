...
/*     */   {
/* 428 */     int[] arrayOfInt = new int['Ā'];
/* 429 */     for (char c = '\000'; c < 'Ā'; c = (char)(c + '\001')) {
...
/*     */   {
/* 635 */     return getClass().getName() + "[font=" + getFont() + "ascent=" + getAscent() + ", descent=" + getDescent() + ", height=" + getHeight() + "]";
/*     */   }
/*     */   
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/FontMetrics.class
