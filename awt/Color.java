...
/*      */     
/*      */ 
/*  647 */     return new Color(Math.min((int)(i / 0.7D), 255), Math.min((int)(j / 0.7D), 255), Math.min((int)(k / 0.7D), 255), m);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   public Color darker()
/*      */   {
/*  673 */     return new Color(Math.max((int)(getRed() * 0.7D), 0), Math.max((int)(getGreen() * 0.7D), 0), Math.max((int)(getBlue() * 0.7D), 0), getAlpha());
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* 1050 */     float[] arrayOfFloat; if (paramArrayOfFloat == null) {
...
/* 1082 */     float[] arrayOfFloat; if (paramArrayOfFloat == null) {
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/Color.class
