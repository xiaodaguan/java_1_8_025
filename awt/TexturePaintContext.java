...
/*     */     
/*     */ 
/*  79 */     boolean bool = paramRenderingHints.get(RenderingHints.KEY_RENDERING) == RenderingHints.VALUE_RENDER_QUALITY;
/*     */     Object localObject2;
/*  81 */     if (((localWritableRaster instanceof IntegerInterleavedRaster)) && ((!bool) || 
/*  82 */       (isFilterableDCM(localColorModel))))
/*     */     {
...
/*     */ 
/*     */ 
/* 119 */       return (isMaskOK(localDirectColorModel.getAlphaMask(), true)) && (isMaskOK(localDirectColorModel.getRedMask(), false)) && (isMaskOK(localDirectColorModel.getGreenMask(), false)) && (isMaskOK(localDirectColorModel.getBlueMask(), false));
/*     */     }
/* 121 */     return false;
/*     */   }
/*     */   
...
/*     */   {
/* 215 */     if ((this.outRas == null) || 
/* 216 */       (this.outRas.getWidth() < paramInt3) || 
/* 217 */       (this.outRas.getHeight() < paramInt4))
/*     */     {
/*     */ 
...
/* 426 */       for (int i5 = 0; i5 < paramInt6; i5++) { int i6;
/* 427 */         int i7; int i8; if (n != 0) {
...
/* 469 */               arrayOfInt2[(i + i6)] = 
/* 470 */                 TexturePaintContext.blend(arrayOfInt3, paramInt3, paramInt4);
/*     */             } else {
/* 472 */               arrayOfInt2[(i + i6)] = arrayOfInt1[(k + paramInt2 * j + paramInt1)];
/*     */             }
/* 474 */             if (paramInt3 += paramInt10 < 0) {
/* 475 */               paramInt3 &= 0x7FFFFFFF;
/* 476 */               paramInt1++;
/*     */             }
...
/* 560 */         m -= paramInt5;
/*     */       }
/* 562 */       for (int i5 = 0; i5 < paramInt6; i5++) { int i6;
/* 563 */         if (n != 0) {
/* 564 */           i6 = k + i2 * j + paramInt7;
/* 565 */           paramInt1 = paramInt7 - i1;
/* 566 */           i += paramInt5;
/* 567 */           int i7; if (paramInt7 >= 32) {
/* 568 */             i7 = paramInt5;
/* 569 */             while (i7 > 0) {
...
/*     */     {
/* 642 */       super(paramAffineTransform, paramByteInterleavedRaster
/*     */       
/* 644 */         .getWidth(), paramByteInterleavedRaster.getHeight(), paramInt);
/* 645 */       this.inPalette = new int['Ā'];
...
/*     */           
/* 702 */           arrayOfInt1[(i + i5)] = 
/* 703 */             TexturePaintContext.blend(arrayOfInt2, paramInt3, paramInt4);
/* 704 */           if (paramInt3 += paramInt10 < 0) {
/* 705 */             paramInt3 &= 0x7FFFFFFF;
/* 706 */             paramInt1++;
/*     */           }
...
/*     */             
/* 791 */             int i4 = TexturePaintContext.blend(arrayOfInt, paramInt3, paramInt4);
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/awt/TexturePaintContext.class
