...
/*     */   {
/* 254 */     for (JDBCType localJDBCType : (JDBCType[])JDBCType.class.getEnumConstants()) {
/* 255 */       if (paramInt == localJDBCType.type.intValue())
/* 256 */         return localJDBCType;
/*     */     }
/* 258 */     throw new IllegalArgumentException("Type:" + paramInt + " is not a valid " + "Types.java value.");
/*     */   }
/*     */ }


/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/sql/JDBCType.class
