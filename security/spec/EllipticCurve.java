...
/* 174 */       if ((this.field.equals(localEllipticCurve.field)) && 
/* 175 */         (this.a.equals(localEllipticCurve.a)) && 
/* 176 */         (this.b.equals(localEllipticCurve.b))) {
/* 177 */         return true;
/*     */       }
/*     */     }
/* 180 */     return false;
...
/*     */   public int hashCode()
/*     */   {
/* 194 */     return this.field.hashCode() << 6 + (this.a.hashCode() << 4) + (this.b.hashCode() << 2);
/*     */   }
/*     */ }


/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/security/spec/EllipticCurve.class
