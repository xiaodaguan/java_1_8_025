...
/* 271 */       return false;
/* 272 */     return Arrays.equals(paramKey1.getEncoded(), paramKey2
/* 273 */       .getEncoded());
/*     */   }
/*     */   
/*     */ 
...
/*     */     {
/* 472 */       str = str + "\tcertificate " + i++ + "\tfor  : " + localCertificate.getPrincipal() + "\n";
/*     */       
/* 474 */       str = str + "\t\t\tfrom : " + localCertificate.getGuarantor() + "\n";
/*     */     }
/*     */     
/* 477 */     return str;
/*     */   }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/security/Identity.class
