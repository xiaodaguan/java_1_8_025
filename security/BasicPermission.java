...
/*     */     }
/*     */     
/*  97 */     int j = paramString.charAt(i - 1);
/*     */     
/*     */ 
/* 100 */     if ((j == 42) && ((i == 1) || (paramString.charAt(i - 2) == '.'))) {
...
/* 170 */       return false;
/*     */     }
/* 172 */     BasicPermission localBasicPermission = (BasicPermission)paramPermission;
/*     */     
/* 174 */     if (this.wildcard) {
/* 175 */       if (localBasicPermission.wildcard)
/*     */       {
/* 177 */         return localBasicPermission.path.startsWith(this.path);
/*     */       }
/*     */       
/*     */ 
/* 181 */       return (localBasicPermission.path.length() > this.path.length()) && (localBasicPermission.path.startsWith(this.path));
/*     */     }
/*     */     
/* 184 */     if (localBasicPermission.wildcard)
/*     */     {
/* 186 */       return false;
/*     */     }
/*     */     
/* 189 */     return this.path.equals(localBasicPermission.path);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 208 */       return false;
/*     */     }
/* 210 */     BasicPermission localBasicPermission = (BasicPermission)paramObject;
/*     */     
/* 212 */     return getName().equals(localBasicPermission.getName());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/security/BasicPermission.class
