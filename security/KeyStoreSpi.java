...
/*     */       {
/* 395 */         CallbackHandler localCallbackHandler = ((KeyStore.CallbackHandlerProtection)localProtectionParameter).getCallbackHandler();
...
/*     */       {
/* 457 */         return new KeyStore.TrustedCertificateEntry(engineGetCertificate(paramString));
/*     */       }
...
/* 538 */         .getPrivateKey(), localPasswordProtection
...
/* 551 */         .getSecretKey(), localPasswordProtection
...
/*     */ 
/*     */ 
/* 559 */     throw new KeyStoreException("unsupported entry type: " + paramEntry.getClass().getName());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     {
/* 585 */       return (engineIsKeyEntry(paramString)) && (engineGetCertificate(paramString) != null);
/*     */     }
/* 587 */     if (paramClass == KeyStore.SecretKeyEntry.class)
/*     */     {
/* 589 */       return (engineIsKeyEntry(paramString)) && (engineGetCertificate(paramString) == null);
/*     */     }
/* 591 */     return false;
/*     */   }
/*     */ }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/security/KeyStoreSpi.class
