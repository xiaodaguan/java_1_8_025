...
/*     */   {
/* 435 */     this.dateAndTime = (paramDate == null ? null : new Date(paramDate.getTime()));
...
/*     */         
/* 635 */         localObject2 = localCRLNumberExtension.get("value");
/*     */       } catch (IOException localIOException) {
/* 637 */         if (debug != null) {
...
/*     */       }
/* 682 */       if ((((Date)localObject3).after((Date)localObject2)) || 
/* 683 */         (localDate.before((Date)localObject1))) {
/* 684 */         if (debug != null) {
...
/* 711 */       throw new InternalError(localCloneNotSupportedException.toString(), localCloneNotSupportedException);
/*     */     }
/*     */   }
/*     */   
/*     */   static {}
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/security/cert/X509CRLSelector.class
