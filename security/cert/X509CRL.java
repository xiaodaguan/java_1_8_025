...
/* 162 */       for (int j = 1; j < arrayOfByte.length; j++) {
/* 163 */         i += arrayOfByte[j] * j;
/*     */       }
/* 165 */       return i;
/*     */     } catch (CRLException localCRLException) {}
/* 167 */     return i;
...
/*     */   {
/* 373 */     X500Principal localX500Principal1 = paramX509Certificate.getIssuerX500Principal();
/* 374 */     X500Principal localX500Principal2 = getIssuerX500Principal();
/* 375 */     if (!localX500Principal1.equals(localX500Principal2)) {
/* 376 */       return null;
/*     */     }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/security/cert/X509CRL.class
