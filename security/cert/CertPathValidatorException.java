...
/*     */     }
/* 181 */     if ((paramInt < -1) || ((paramCertPath != null) && 
/* 182 */       (paramInt >= paramCertPath.getCertificates().size()))) {
...
/*     */     }
/* 240 */     if ((this.index < -1) || ((this.certPath != null) && 
/* 241 */       (this.index >= this.certPath.getCertificates().size()))) {
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/security/cert/CertPathValidatorException.class
