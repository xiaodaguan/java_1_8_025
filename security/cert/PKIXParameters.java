...
/*     */     
/*     */ 
/* 210 */     this.unmodTrustAnchors = Collections.unmodifiableSet(new HashSet(paramSet));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */       }
/*     */       
/* 259 */       this.unmodInitialPolicies = Collections.unmodifiableSet(new HashSet(paramSet));
/*     */     } else {
...
/*     */   {
/* 319 */     return Collections.unmodifiableList(new ArrayList(this.certStores));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */       {
/* 674 */         localPKIXParameters.certPathCheckers = new ArrayList(this.certPathCheckers.size());
/* 675 */         for (PKIXCertPathChecker localPKIXCertPathChecker : this.certPathCheckers) {
/* 676 */           localPKIXParameters.certPathCheckers.add(
/* 677 */             (PKIXCertPathChecker)localPKIXCertPathChecker.clone());
/*     */         }
/*     */       }
/*     */       
/*     */ 
...
/* 686 */       throw new InternalError(localCloneNotSupportedException.toString(), localCloneNotSupportedException);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */       } else {
/* 710 */         localStringBuffer.append("  Initial Policy OIDs: [" + this.unmodInitialPolicies
/* 711 */           .toString() + "]\n");
/*     */       }
/*     */     }
/*     */     
...
/* 729 */       localStringBuffer.append("  Certification Path Checkers: [" + this.certPathCheckers
/* 730 */         .toString() + "]\n");
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/security/cert/PKIXParameters.class
