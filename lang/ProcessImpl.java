...
/*     */         }
/*     */         else {
/* 115 */           localFileOutputStream1 = new FileOutputStream(paramArrayOfRedirect[1].file(), paramArrayOfRedirect[1].append());
...
/*     */         }
/*     */         else {
/* 125 */           localFileOutputStream2 = new FileOutputStream(paramArrayOfRedirect[2].file(), paramArrayOfRedirect[2].append());
...
/*     */ 
/*     */ 
/* 134 */       return new UNIXProcess(toCString(paramArrayOfString[0]), arrayOfByte1, arrayOfByte.length, arrayOfByte2, ???[0], toCString(paramString), arrayOfInt, paramBoolean);
/*     */     }
/*     */     finally
/*     */     {
/*     */       try
...
/*     */       } finally {
/* 142 */         try { if (localFileOutputStream1 != null) localFileOutputStream1.close();
/* 143 */         } finally { if (localFileOutputStream2 != null) localFileOutputStream2.close();
/*     */         }
/*     */       }
/*     */     }
/*     */   }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/lang/ProcessImpl.class
