...
/*     */   {
/* 173 */     return getClassName() + "." + this.methodName + (this.fileName != null ? "(" + this.fileName + ")" : (this.fileName != null) && (this.lineNumber >= 0) ? "(" + this.fileName + ":" + this.lineNumber + ")" : isNativeMethod() ? "(Native Method)" : "(Unknown Source)");
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 204 */     if ((localStackTraceElement.declaringClass.equals(this.declaringClass)) && (localStackTraceElement.lineNumber == this.lineNumber)) {}
/*     */     
/*     */ 
/* 207 */     return (Objects.equals(this.methodName, localStackTraceElement.methodName)) && (Objects.equals(this.fileName, localStackTraceElement.fileName));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/lang/StackTraceElement.class
