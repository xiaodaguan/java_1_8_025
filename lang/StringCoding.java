...
/*  65 */       return null;
/*  66 */     return (T)localSoftReference.get();
/*     */   }
/*     */   
...
/*     */       
/*     */ 
/* 133 */       this.cd = paramCharset.newDecoder().onMalformedInput(CodingErrorAction.REPLACE).onUnmappableCharacter(CodingErrorAction.REPLACE);
...
/* 181 */     if ((localStringDecoder == null) || ((!str.equals(localStringDecoder.requestedCharsetName())) && 
/* 182 */       (!str.equals(localStringDecoder.charsetName())))) {
...
/*     */     
/*     */ 
/* 227 */     localCharsetDecoder.onMalformedInput(CodingErrorAction.REPLACE).onUnmappableCharacter(CodingErrorAction.REPLACE).reset();
...
/*     */       {
/* 263 */         MessageUtils.err(
/* 264 */           "ISO-8859-1 charset not available: " + localUnsupportedEncodingException2.toString());
/*     */         
/*     */ 
/* 267 */         System.exit(1); } }
/* 268 */     return null;
...
/*     */       
/*     */ 
/* 284 */       this.ce = paramCharset.newEncoder().onMalformedInput(CodingErrorAction.REPLACE).onUnmappableCharacter(CodingErrorAction.REPLACE);
...
/* 332 */     if ((localStringEncoder == null) || ((!str.equals(localStringEncoder.requestedCharsetName())) && 
/* 333 */       (!str.equals(localStringEncoder.charsetName())))) {
...
/*     */     
/*     */ 
/* 362 */     localCharsetEncoder.onMalformedInput(CodingErrorAction.REPLACE).onUnmappableCharacter(CodingErrorAction.REPLACE).reset();
...
/*     */       catch (UnsupportedEncodingException localUnsupportedEncodingException2)
/*     */       {
/* 396 */         MessageUtils.err(
/* 397 */           "ISO-8859-1 charset not available: " + localUnsupportedEncodingException2.toString());
/*     */         
/*     */ 
/* 400 */         System.exit(1); } }
/* 401 */     return null;
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/lang/StringCoding.class
