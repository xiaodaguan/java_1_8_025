...
/*      */   {
/*  236 */     return paramDouble / 180.0D * 3.141592653589793D;
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/*  252 */     return paramDouble * 180.0D / 3.141592653589793D;
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*  718 */     long l2 = (l1 & 0x7FF0000000000000) >> 52;
/*      */     
/*  720 */     long l3 = 1074L - l2;
/*      */     
/*  722 */     if ((l3 & 0xFFFFFFFFFFFFFFC0) == 0L)
/*      */     {
/*  724 */       long l4 = l1 & 0xFFFFFFFFFFFFF | 0x10000000000000;
/*      */       
/*  726 */       if (l1 < 0L) {
/*  727 */         l4 = -l4;
/*      */       }
...
/*      */ 
/*      */ 
/*  735 */       return (l4 >> (int)l3) + 1L >> 1;
/*      */     }
/*      */     
/*      */ 
/*      */ 
/*      */ 
/*  741 */     return paramDouble;
/*      */   }
/*      */   
...
/*      */   {
/* 1139 */     int i = paramInt1 - floorDiv(paramInt1, paramInt2) * paramInt2;
/* 1140 */     return i;
/*      */   }
/*      */   
/*      */ 
...
/*      */     {
/* 1292 */       if (Float.floatToRawIntBits(paramFloat1) == negativeZeroFloatBits)
/*      */       {
...
/*      */     {
/* 1318 */       if (Double.doubleToRawLongBits(paramDouble1) == negativeZeroDoubleBits)
/*      */       {
...
/*      */     {
/* 1372 */       if (Float.floatToRawIntBits(paramFloat2) == negativeZeroFloatBits)
/*      */       {
...
/*      */     {
/* 1398 */       if (Double.doubleToRawLongBits(paramDouble2) == negativeZeroDoubleBits)
/*      */       {
...
/*      */ 
/*      */ 
/* 1450 */     return Double.longBitsToDouble(1L << i - 64462);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */ 
/*      */ 
/* 1501 */     return Float.intBitsToFloat(1 << i - 65387);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1766 */     return Double.longBitsToDouble(Double.doubleToRawLongBits(paramDouble2) & 0x8000000000000000 | 
/*      */     
/* 1768 */       Double.doubleToRawLongBits(paramDouble1) & 0x7FFFFFFFFFFFFFFF);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1789 */     return Float.intBitsToFloat(Float.floatToRawIntBits(paramFloat2) & 0x80000000 | 
/*      */     
/* 1791 */       Float.floatToRawIntBits(paramFloat1) & 0x7FFFFFFF);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1840 */     return (int)(((Double.doubleToRawLongBits(paramDouble) & 0x7FF0000000000000) >> 52) - 1023L);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* 2262 */     int i = 0;
/* 2263 */     int j = 0;
/* 2264 */     double d = NaN.0D;
/*      */     
/*      */ 
/*      */ 
/* 2268 */     if (paramInt < 0) {
/* 2269 */       paramInt = max(paramInt, 63437);
/* 2270 */       j = 65024;
...
/*      */ 
/*      */ 
/* 2281 */     int k = paramInt >> 8 >>> 23;
/* 2282 */     i = (paramInt + k & 0x1FF) - k;
/*      */     
...
/*      */   {
/* 2333 */     paramInt = max(min(paramInt, 278), 65258);
/*      */     
/*      */ 
/*      */ 
/*      */ 
...
/* 2349 */   static double twoToTheDoubleScaleDown = powerOfTwoD(65024);
/*      */   
/*      */ 
/*      */ 
/*      */   static double powerOfTwoD(int paramInt)
/*      */   {
/* 2355 */     assert ((paramInt >= 64514) && (paramInt <= 1023));
/* 2356 */     return Double.longBitsToDouble(paramInt + 1023L << 52 & 0x7FF0000000000000);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/lang/Math.class
