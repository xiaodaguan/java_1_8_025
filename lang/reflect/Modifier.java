...
/*     */     
/*  56 */     localReflectionFactory.setLangReflectAccess(new ReflectAccess());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/*     */ 
/* 238 */     if ((paramInt & 0x1) != 0) localStringBuilder.append("public ");
/* 239 */     if ((paramInt & 0x4) != 0) localStringBuilder.append("protected ");
/* 240 */     if ((paramInt & 0x2) != 0) { localStringBuilder.append("private ");
/*     */     }
/*     */     
/* 243 */     if ((paramInt & 0x400) != 0) localStringBuilder.append("abstract ");
/* 244 */     if ((paramInt & 0x8) != 0) localStringBuilder.append("static ");
/* 245 */     if ((paramInt & 0x10) != 0) localStringBuilder.append("final ");
/* 246 */     if ((paramInt & 0x80) != 0) localStringBuilder.append("transient ");
/* 247 */     if ((paramInt & 0x40) != 0) localStringBuilder.append("volatile ");
/* 248 */     if ((paramInt & 0x20) != 0) localStringBuilder.append("synchronized ");
/* 249 */     if ((paramInt & 0x100) != 0) localStringBuilder.append("native ");
/* 250 */     if ((paramInt & 0x800) != 0) localStringBuilder.append("strictfp ");
/* 251 */     if ((paramInt & 0x200) != 0) localStringBuilder.append("interface ");
/*     */     int i;
/* 253 */     if ((i = localStringBuilder.length()) > 0)
/* 254 */       return localStringBuilder.toString().substring(0, i - 1);
/* 255 */     return "";
/*     */   }
/*     */   
/*     */ 
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/lang/reflect/Modifier.class
