...
/*      */ 
/*      */ 
/*  619 */   private static ThreadGroup rootGroup = ;
/*      */   
...
/*      */     }
/* 1345 */     Object localObject = SecurityConstants.AWT.TOPLEVEL_WINDOW_PERMISSION;
/* 1346 */     if (localObject == null) {
/* 1347 */       localObject = SecurityConstants.ALL_PERMISSION;
/*      */     }
/*      */     try {
/* 1350 */       checkPermission((Permission)localObject);
/* 1351 */       return true;
/*      */     }
/*      */     catch (SecurityException localSecurityException) {}
/*      */     
...
/*      */   {
/* 1410 */     Object localObject = SecurityConstants.AWT.ACCESS_CLIPBOARD_PERMISSION;
/* 1411 */     if (localObject == null) {
/* 1412 */       localObject = SecurityConstants.ALL_PERMISSION;
/*      */     }
/* 1414 */     checkPermission((Permission)localObject);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 1446 */     Object localObject = SecurityConstants.AWT.CHECK_AWT_EVENTQUEUE_PERMISSION;
/* 1447 */     if (localObject == null) {
/* 1448 */       localObject = SecurityConstants.ALL_PERMISSION;
/*      */     }
/* 1450 */     checkPermission((Permission)localObject);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */ 
/*      */ 
/* 1469 */   private static boolean packageAccessValid = false;
/*      */   private static String[] packageAccess;
/* 1471 */   private static final Object packageAccessLock = new Object();
/*      */   
/* 1473 */   private static boolean packageDefinitionValid = false;
...
/* 1480 */       StringTokenizer localStringTokenizer = new StringTokenizer(paramString, ",");
/*      */       
/* 1482 */       int i = localStringTokenizer.countTokens();
/* 1483 */       if (i > 0) {
/* 1484 */         arrayOfString = new String[i];
/* 1485 */         int j = 0;
/* 1486 */         while (localStringTokenizer.hasMoreElements()) {
/* 1487 */           String str = localStringTokenizer.nextToken().trim();
/* 1488 */           arrayOfString[(j++)] = str;
/*      */         }
/*      */       }
/*      */     }
/*      */     
...
/*      */       {
/* 1542 */         String str = (String)AccessController.doPrivileged(new PrivilegedAction()
/*      */         {
/*      */           public String run() {
...
/*      */ 
/*      */ 
/* 1562 */     for (int i = 0; i < arrayOfString.length; i++) {
/* 1563 */       if ((paramString.startsWith(arrayOfString[i])) || (arrayOfString[i].equals(paramString + "."))) {
...
/*      */       {
/* 1611 */         String str = (String)AccessController.doPrivileged(new PrivilegedAction()
/*      */         {
/*      */           public String run() {
...
/*      */ 
/*      */ 
/* 1630 */     for (int i = 0; i < arrayOfString.length; i++) {
/* 1631 */       if ((paramString.startsWith(arrayOfString[i])) || (arrayOfString[i].equals(paramString + "."))) {
...
/*      */ 
/*      */ 
/* 1721 */       if ((arrayOfClass.length < 4) || 
/* 1722 */         (arrayOfClass[3].getClassLoader() != paramClass.getClassLoader())) {
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/lang/SecurityManager.class
