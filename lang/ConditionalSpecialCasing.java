...
/* 160 */         if (((str2 == null) || (str2.equals(str1))) && 
/* 161 */           (isConditionMet(paramString, paramInt, paramLocale, localEntry.getCondition()))) {
...
/* 315 */     int i; for (; m < k; m += Character.charCount(i))
/*     */     {
...
/* 348 */     int i; for (; m < k; m += Character.charCount(i))
/*     */     {
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/lang/ConditionalSpecialCasing.class
