...
/*     */   
/*     */ 
/* 313 */   private static final String[] methods = { "GET", "POST", "HEAD", "OPTIONS", "PUT", "DELETE", "TRACE" };
/*     */   
...
/*     */     {
/* 347 */       localSecurityManager.checkSetFactory();
/*     */     }
...
/* 429 */       if (methods[i].equals(paramString)) {
...
/* 433 */             localSecurityManager.checkPermission(new NetPermission("allowHttpTrace"));
/*     */           }
/*     */         }
...
/*     */ 
/*     */ 
/* 478 */     Object localObject = null;
/*     */     try {
/* 480 */       getInputStream();
/*     */     } catch (Exception localException) {
/* 482 */       localObject = localException;
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/* 490 */     if (str == null) {
/* 491 */       if (localObject != null) {
/* 492 */         if ((localObject instanceof RuntimeException)) {
/* 493 */           throw ((RuntimeException)localObject);
/*     */         }
/* 495 */         throw ((IOException)localObject);
/*     */       }
/* 497 */       return -1;
/*     */     }
/*     */     
...
/*     */         try
/*     */         {
/* 524 */           this.responseCode = Integer.parseInt(str.substring(i + 1, j));
...
/* 594 */     SocketPermission localSocketPermission = new SocketPermission(str, "connect");
/* 595 */     return localSocketPermission;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/net/HttpURLConnection.class
