...
/*     */       {
/* 121 */         bool = (localInetSocketAddressHolder.addr == null) && (this.hostname.equalsIgnoreCase(localInetSocketAddressHolder.hostname));
/*     */       } else
...
/*     */   {
/* 188 */     this.holder = new InetSocketAddressHolder(null, paramInetAddress == null ? InetAddress.anyLocalAddress() : paramInetAddress, checkPort(paramInt), null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 310 */       FIELDS_OFFSET = localUnsafe.objectFieldOffset(InetSocketAddress.class
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/net/InetSocketAddress.class
