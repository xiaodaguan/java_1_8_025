...
/*     */   {
/* 188 */     ChronoLocalDateTimeImpl localChronoLocalDateTimeImpl = (ChronoLocalDateTimeImpl)paramTemporal;
/* 189 */     if (!paramChronology.equals(localChronoLocalDateTimeImpl.getChronology()))
/*     */     {
/* 191 */       throw new ClassCastException("Chronology mismatch, required: " + paramChronology.getId() + ", actual: " + localChronoLocalDateTimeImpl.getChronology().getId());
/*     */     }
/* 193 */     return localChronoLocalDateTimeImpl;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 222 */     ChronoLocalDate localChronoLocalDate = ChronoLocalDateImpl.ensureValid(this.date.getChronology(), paramTemporal);
/* 223 */     return new ChronoLocalDateTimeImpl(localChronoLocalDate, paramLocalTime);
/*     */   }
/*     */   
/*     */ 
...
/* 241 */       ChronoField localChronoField = (ChronoField)paramTemporalField;
/* 242 */       return (localChronoField.isDateBased()) || (localChronoField.isTimeBased());
/*     */     }
...
/* 250 */       ChronoField localChronoField = (ChronoField)paramTemporalField;
/* 251 */       return localChronoField.isTimeBased() ? this.time.range(paramTemporalField) : this.date.range(paramTemporalField);
/*     */     }
...
/* 259 */       ChronoField localChronoField = (ChronoField)paramTemporalField;
/* 260 */       return localChronoField.isTimeBased() ? this.time.get(paramTemporalField) : this.date.get(paramTemporalField);
/*     */     }
...
/* 268 */       ChronoField localChronoField = (ChronoField)paramTemporalField;
/* 269 */       return localChronoField.isTimeBased() ? this.time.getLong(paramTemporalField) : this.date.getLong(paramTemporalField);
/*     */     }
...
/* 282 */       return with(this.date, (LocalTime)paramTemporalAdjuster);
...
/*     */     }
/* 286 */     return ensureValid(this.date.getChronology(), (ChronoLocalDateTimeImpl)paramTemporalAdjuster.adjustInto(this));
/*     */   }
/*     */   
...
/* 292 */       ChronoField localChronoField = (ChronoField)paramTemporalField;
/* 293 */       if (localChronoField.isTimeBased()) {
/* 294 */         return with(this.date, this.time.with(paramTemporalField, paramLong));
/*     */       }
...
/* 306 */       ChronoUnit localChronoUnit = (ChronoUnit)paramTemporalUnit;
/* 307 */       switch (localChronoUnit) {
/* 308 */       case NANOS:  return plusNanos(paramLong);
...
/* 345 */       return with(paramD, this.time);
/*     */     }
...
/* 359 */     LocalTime localLocalTime = l4 == l3 ? this.time : LocalTime.ofNanoOfDay(l4);
/* 360 */     return with(paramD.plus(l1, ChronoUnit.DAYS), localLocalTime);
/*     */   }
/*     */   
/*     */ 
...
/*     */     
/* 374 */     ChronoLocalDateTime localChronoLocalDateTime = getChronology().localDateTime(paramTemporal);
/* 375 */     if ((paramTemporalUnit instanceof ChronoUnit)) {
/* 376 */       if (paramTemporalUnit.isTimeBased()) {
/* 377 */         long l = localChronoLocalDateTime.getLong(ChronoField.EPOCH_DAY) - this.date.getLong(ChronoField.EPOCH_DAY);
/* 378 */         switch ((ChronoUnit)paramTemporalUnit) {
/* 379 */         case NANOS:  l = Math.multiplyExact(l, 86400000000000L); break;
...
/* 385 */         case HALF_DAYS:  l = Math.multiplyExact(l, 2L);
/*     */         }
/* 387 */         return Math.addExact(l, this.time.until(localChronoLocalDateTime.toLocalTime(), paramTemporalUnit));
/*     */       }
/* 389 */       ChronoLocalDate localChronoLocalDate = localChronoLocalDateTime.toLocalDate();
/* 390 */       if (localChronoLocalDateTime.toLocalTime().isBefore(this.time)) {
/* 391 */         localChronoLocalDate = localChronoLocalDate.minus(1L, ChronoUnit.DAYS);
/*     */       }
/* 393 */       return this.date.until(localChronoLocalDate, paramTemporalUnit);
/*     */     }
/* 395 */     Objects.requireNonNull(paramTemporalUnit, "unit");
/* 396 */     return paramTemporalUnit.between(this, localChronoLocalDateTime);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 432 */     ChronoLocalDate localChronoLocalDate = (ChronoLocalDate)paramObjectInput.readObject();
/* 433 */     LocalTime localLocalTime = (LocalTime)paramObjectInput.readObject();
/* 434 */     return localChronoLocalDate.atTime(localLocalTime);
/*     */   }
/*     */   
/*     */ 
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/time/chrono/ChronoLocalDateTimeImpl.class
