...
/*     */   {
/* 383 */     return ((paramLong & 0x3) == 0L) && ((paramLong % 100L != 0L) || (paramLong % 400L == 0L));
/*     */   }
/*     */   
...
/*     */   {
/* 401 */     return Arrays.asList(IsoEra.values());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 497 */     Long localLong = (Long)paramMap.remove(ChronoField.PROLEPTIC_MONTH);
/* 498 */     if (localLong != null) {
/* 499 */       if (paramResolverStyle != ResolverStyle.LENIENT) {
/* 500 */         ChronoField.PROLEPTIC_MONTH.checkValidValue(localLong.longValue());
/*     */       }
/* 502 */       addFieldValue(paramMap, ChronoField.MONTH_OF_YEAR, Math.floorMod(localLong.longValue(), 12L) + 1L);
/* 503 */       addFieldValue(paramMap, ChronoField.YEAR, Math.floorDiv(localLong.longValue(), 12L));
/*     */     }
/*     */   }
/*     */   
/*     */   LocalDate resolveYearOfEra(Map<TemporalField, Long> paramMap, ResolverStyle paramResolverStyle)
/*     */   {
/* 509 */     Long localLong1 = (Long)paramMap.remove(ChronoField.YEAR_OF_ERA);
/* 510 */     if (localLong1 != null) {
/* 511 */       if (paramResolverStyle != ResolverStyle.LENIENT) {
/* 512 */         ChronoField.YEAR_OF_ERA.checkValidValue(localLong1.longValue());
/*     */       }
/* 514 */       Long localLong2 = (Long)paramMap.remove(ChronoField.ERA);
/* 515 */       if (localLong2 == null) {
/* 516 */         Long localLong3 = (Long)paramMap.get(ChronoField.YEAR);
/* 517 */         if (paramResolverStyle == ResolverStyle.STRICT)
/*     */         {
/* 519 */           if (localLong3 != null) {
/* 520 */             addFieldValue(paramMap, ChronoField.YEAR, localLong3.longValue() > 0L ? localLong1.longValue() : Math.subtractExact(1L, localLong1.longValue()));
/*     */           }
/*     */           else {
/* 523 */             paramMap.put(ChronoField.YEAR_OF_ERA, localLong1);
/*     */           }
/*     */         }
/*     */         else {
/* 527 */           addFieldValue(paramMap, ChronoField.YEAR, (localLong3 == null) || (localLong3.longValue() > 0L) ? localLong1.longValue() : Math.subtractExact(1L, localLong1.longValue()));
/*     */         }
/* 529 */       } else if (localLong2.longValue() == 1L) {
/* 530 */         addFieldValue(paramMap, ChronoField.YEAR, localLong1.longValue());
/* 531 */       } else if (localLong2.longValue() == 0L) {
/* 532 */         addFieldValue(paramMap, ChronoField.YEAR, Math.subtractExact(1L, localLong1.longValue()));
/*     */       } else {
/* 534 */         throw new DateTimeException("Invalid value for era: " + localLong2);
/*     */       }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/time/chrono/IsoChronology.class
