...
/*     */   {
/* 309 */     return Arrays.asList(MinguoEra.values());
/*     */   }
/*     */   
...
/* 317 */       localValueRange = ChronoField.PROLEPTIC_MONTH.range();
/* 318 */       return ValueRange.of(localValueRange.getMinimum() - 22932L, localValueRange.getMaximum() - 22932L);
/*     */     
/*     */     case YEAR_OF_ERA: 
/* 321 */       localValueRange = ChronoField.YEAR.range();
/* 322 */       return ValueRange.of(1L, localValueRange.getMaximum() - 1911L, -localValueRange.getMinimum() + 1L + 1911L);
/*     */     
/*     */     case YEAR: 
/* 325 */       localValueRange = ChronoField.YEAR.range();
/* 326 */       return ValueRange.of(localValueRange.getMinimum() - 1911L, localValueRange.getMaximum() - 1911L);
/*     */     }
/*     */     
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/time/chrono/MinguoChronology.class
