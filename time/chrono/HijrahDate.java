...
/* 351 */         ChronoField localChronoField = (ChronoField)paramTemporalField;
/* 352 */         switch (localChronoField) {
/* 353 */         case DAY_OF_MONTH:  return ValueRange.of(1L, lengthOfMonth());
/* 354 */         case DAY_OF_YEAR:  return ValueRange.of(1L, lengthOfYear());
/* 355 */         case ALIGNED_WEEK_OF_MONTH:  return ValueRange.of(1L, 5L);
/*     */         }
/*     */         
/*     */         
/* 359 */         return getChronology().range(localChronoField);
/*     */       }
...
/* 369 */       switch ((ChronoField)paramTemporalField) {
...
/* 396 */       ChronoField localChronoField = (ChronoField)paramTemporalField;
/*     */       
/* 398 */       this.chrono.range(localChronoField).checkValidValue(paramLong, localChronoField);
/* 399 */       int i = (int)paramLong;
/* 400 */       switch (localChronoField) {
/* 401 */       case DAY_OF_WEEK:  return plusDays(paramLong - getDayOfWeek());
...
/*     */     }
/* 417 */     return (HijrahDate)super.with(paramTemporalField, paramLong);
/*     */   }
/*     */   
...
/*     */   {
/* 436 */     return (HijrahDate)super.with(paramTemporalAdjuster);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 465 */     return (HijrahDate)super.plus(paramTemporalAmount);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 475 */     return (HijrahDate)super.minus(paramTemporalAmount);
/*     */   }
/*     */   
...
/*     */   {
/* 548 */     return (HijrahDate)super.plusWeeks(paramLong);
/*     */   }
/*     */   
...
/*     */   {
/* 558 */     return (HijrahDate)super.plus(paramLong, paramTemporalUnit);
/*     */   }
/*     */   
/*     */   public HijrahDate minus(long paramLong, TemporalUnit paramTemporalUnit)
/*     */   {
/* 563 */     return (HijrahDate)super.minus(paramLong, paramTemporalUnit);
/*     */   }
/*     */   
/*     */   HijrahDate minusYears(long paramLong)
/*     */   {
/* 568 */     return (HijrahDate)super.minusYears(paramLong);
/*     */   }
/*     */   
/*     */   HijrahDate minusMonths(long paramLong)
/*     */   {
/* 573 */     return (HijrahDate)super.minusMonths(paramLong);
/*     */   }
/*     */   
/*     */   HijrahDate minusWeeks(long paramLong)
/*     */   {
/* 578 */     return (HijrahDate)super.minusWeeks(paramLong);
/*     */   }
/*     */   
/*     */   HijrahDate minusDays(long paramLong)
/*     */   {
/* 583 */     return (HijrahDate)super.minusDays(paramLong);
/*     */   }
/*     */   
/*     */ 
/*     */   public final ChronoLocalDateTime<HijrahDate> atTime(LocalTime paramLocalTime)
/*     */   {
/* 589 */     return super.atTime(paramLocalTime);
/*     */   }
/*     */   
/*     */ 
/*     */   public ChronoPeriod until(ChronoLocalDate paramChronoLocalDate)
/*     */   {
/* 595 */     HijrahDate localHijrahDate1 = getChronology().date(paramChronoLocalDate);
/* 596 */     long l1 = (localHijrahDate1.prolepticYear - this.prolepticYear) * 12 + (localHijrahDate1.monthOfYear - this.monthOfYear);
/* 597 */     int i = localHijrahDate1.dayOfMonth - this.dayOfMonth;
/* 598 */     if ((l1 > 0L) && (i < 0)) {
/* 599 */       l1 -= 1L;
/* 600 */       HijrahDate localHijrahDate2 = plusMonths(l1);
/* 601 */       i = (int)(localHijrahDate1.toEpochDay() - localHijrahDate2.toEpochDay());
/* 602 */     } else if ((l1 < 0L) && (i > 0)) {
/* 603 */       l1 += 1L;
/* 604 */       i -= localHijrahDate1.lengthOfMonth();
/*     */     }
/* 606 */     long l2 = l1 / 12L;
...
/* 630 */       HijrahDate localHijrahDate = (HijrahDate)paramObject;
/* 631 */       if ((this.prolepticYear == localHijrahDate.prolepticYear) && (this.monthOfYear == localHijrahDate.monthOfYear) && (this.dayOfMonth == localHijrahDate.dayOfMonth)) {}
/*     */       
/*     */ 
/* 634 */       return getChronology().equals(localHijrahDate.getChronology());
/*     */     }
/* 636 */     return false;
/*     */   }
/*     */   
...
/* 649 */     return getChronology().getId().hashCode() ^ i & 0xF800 ^ (i << 11) + (j << 6) + k;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 691 */     HijrahChronology localHijrahChronology = (HijrahChronology)paramObjectInput.readObject();
/* 692 */     int i = paramObjectInput.readInt();
/* 693 */     int j = paramObjectInput.readByte();
/* 694 */     int k = paramObjectInput.readByte();
/* 695 */     return localHijrahChronology.date(i, j, k);
/*     */   }
/*     */ }


/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/time/chrono/HijrahDate.class
