...
/*     */   {
/* 345 */     return Arrays.asList(ThaiBuddhistEra.values());
/*     */   }
/*     */   
...
/* 353 */       localValueRange = ChronoField.PROLEPTIC_MONTH.range();
/* 354 */       return ValueRange.of(localValueRange.getMinimum() + 6516L, localValueRange.getMaximum() + 6516L);
/*     */     
/*     */     case YEAR_OF_ERA: 
/* 357 */       localValueRange = ChronoField.YEAR.range();
/* 358 */       return ValueRange.of(1L, -(localValueRange.getMinimum() + 543L) + 1L, localValueRange.getMaximum() + 543L);
/*     */     
/*     */     case YEAR: 
/* 361 */       localValueRange = ChronoField.YEAR.range();
/* 362 */       return ValueRange.of(localValueRange.getMinimum() + 543L, localValueRange.getMaximum() + 543L);
/*     */     }
/*     */     
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/time/chrono/ThaiBuddhistChronology.class
