...
/*     */     }
/*     */     
/* 349 */     JapaneseEra localJapaneseEra = (JapaneseEra)paramEra;
/* 350 */     int i = localJapaneseEra.getPrivateEra().getSinceDate().getYear() + paramInt - 1;
/* 351 */     if (paramInt == 1) {
/* 352 */       return i;
/*     */     }
/* 354 */     if ((i >= -999999999) && (i <= 999999999)) {
/* 355 */       LocalGregorianCalendar.Date localDate = JCAL.newCalendarDate(null);
/* 356 */       localDate.setEra(localJapaneseEra.getPrivateEra()).setDate(paramInt, 1, 1);
/* 357 */       if (JCAL.validate(localDate)) {
/* 358 */         return i;
/*     */       }
/*     */     }
...
/*     */   {
/* 382 */     return Arrays.asList(JapaneseEra.values());
/*     */   }
/*     */   
...
/*     */     case YEAR_OF_ERA: 
/* 401 */       localCalendar = Calendar.getInstance(LOCALE);
/* 402 */       i = getCurrentEra().getPrivateEra().getSinceDate().getYear();
/* 403 */       return ValueRange.of(1L, localCalendar.getGreatestMinimum(1), localCalendar
/* 404 */         .getLeastMaximum(1) + 1, 999999999 - i);
/*     */     
/*     */ 
/*     */     case DAY_OF_YEAR: 
/* 408 */       localCalendar = Calendar.getInstance(LOCALE);
/* 409 */       i = 6;
/* 410 */       return ValueRange.of(localCalendar.getMinimum(i), localCalendar.getGreatestMinimum(i), localCalendar
/* 411 */         .getLeastMaximum(i), localCalendar.getMaximum(i));
/*     */     
/*     */     case YEAR: 
...
/*     */   {
/* 431 */     Long localLong1 = (Long)paramMap.get(ChronoField.ERA);
/* 432 */     JapaneseEra localJapaneseEra = null;
/* 433 */     if (localLong1 != null) {
/* 434 */       localJapaneseEra = eraOf(range(ChronoField.ERA).checkValidIntValue(localLong1.longValue(), ChronoField.ERA));
/*     */     }
/* 436 */     Long localLong2 = (Long)paramMap.get(ChronoField.YEAR_OF_ERA);
/* 437 */     int i = 0;
/* 438 */     if (localLong2 != null) {
/* 439 */       i = range(ChronoField.YEAR_OF_ERA).checkValidIntValue(localLong2.longValue(), ChronoField.YEAR_OF_ERA);
/*     */     }
/*     */     
/* 442 */     if ((localJapaneseEra == null) && (localLong2 != null) && (!paramMap.containsKey(ChronoField.YEAR)) && (paramResolverStyle != ResolverStyle.STRICT)) {
/* 443 */       localJapaneseEra = JapaneseEra.values()[(JapaneseEra.values().length - 1)];
/*     */     }
/*     */     
/* 446 */     if ((localLong2 != null) && (localJapaneseEra != null)) {
/* 447 */       if ((paramMap.containsKey(ChronoField.MONTH_OF_YEAR)) && 
/* 448 */         (paramMap.containsKey(ChronoField.DAY_OF_MONTH))) {
/* 449 */         return resolveYMD(localJapaneseEra, i, paramMap, paramResolverStyle);
/*     */       }
/*     */       
/* 452 */       if (paramMap.containsKey(ChronoField.DAY_OF_YEAR)) {
/* 453 */         return resolveYD(localJapaneseEra, i, paramMap, paramResolverStyle);
/*     */       }
/*     */     }
/* 456 */     return null;
/*     */   }
...
/* 467 */       i = prolepticYearLenient(paramJapaneseEra, paramInt);
...
/* 470 */       return date(i, 1, 1).plus(l1, ChronoUnit.MONTHS).plus(l2, ChronoUnit.DAYS);
/*     */     }
...
/*     */       try {
/* 481 */         localJapaneseDate = date(k, i, j);
/*     */       } catch (DateTimeException localDateTimeException) {
/* 483 */         localJapaneseDate = date(k, i, 1).with(TemporalAdjusters.lastDayOfMonth());
/*     */       }
/*     */       
/*     */ 
/*     */ 
/* 488 */       if ((localJapaneseDate.getEra() != paramJapaneseEra) && (localJapaneseDate.get(ChronoField.YEAR_OF_ERA) > 1) && (paramInt > 1)) {
/* 489 */         throw new DateTimeException("Invalid YearOfEra for Era: " + paramJapaneseEra + " " + paramInt);
/*     */       }
/* 491 */       return localJapaneseDate;
/*     */     }
...
/* 500 */       i = prolepticYearLenient(paramJapaneseEra, paramInt);
/* 501 */       long l = Math.subtractExact(((Long)paramMap.remove(ChronoField.DAY_OF_YEAR)).longValue(), 1L);
/* 502 */       return dateYearDay(i, 1).plus(l, ChronoUnit.DAYS);
/*     */     }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/time/chrono/JapaneseChronology.class
