...
/* 226 */     ZoneOffset localZoneOffset1 = Ser.readOffset(paramDataInput);
/* 227 */     ZoneOffset localZoneOffset2 = Ser.readOffset(paramDataInput);
/* 228 */     if (localZoneOffset1.equals(localZoneOffset2)) {
/* 229 */       throw new IllegalArgumentException("Offsets must not be equal");
/*     */     }
/* 231 */     return new ZoneOffsetTransition(l, localZoneOffset1, localZoneOffset2);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 418 */       ZoneOffsetTransition localZoneOffsetTransition = (ZoneOffsetTransition)paramObject;
/*     */       
/* 420 */       return (this.transition.equals(localZoneOffsetTransition.transition)) && (this.offsetBefore.equals(localZoneOffsetTransition.offsetBefore)) && (this.offsetAfter.equals(localZoneOffsetTransition.offsetAfter));
/*     */     }
/* 422 */     return false;
/*     */   }
/*     */   
...
/*     */   {
/* 443 */     StringBuilder localStringBuilder = new StringBuilder();
/* 444 */     localStringBuilder.append("Transition[")
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/time/zone/ZoneOffsetTransition.class
