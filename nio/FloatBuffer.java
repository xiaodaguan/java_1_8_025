...
/* 1163 */       return false;
/* 1164 */     FloatBuffer localFloatBuffer = (FloatBuffer)paramObject;
/* 1165 */     if (remaining() != localFloatBuffer.remaining())
/* 1166 */       return false;
/* 1167 */     int i = position();
/* 1168 */     int j = limit() - 1; for (int k = localFloatBuffer.limit() - 1; j >= i; k--) {
/* 1169 */       if (!equals(get(j), localFloatBuffer.get(k))) {
/* 1170 */         return false;
/*      */       }
/* 1168 */       j--;
/*      */     }
...
/* 1207 */     int j = position(); for (int k = paramFloatBuffer.position(); j < i; k++) {
...
/*      */   {
/* 1220 */     return Float.isNaN(paramFloat1) ? 1 : Float.isNaN(paramFloat2) ? 0 : paramFloat1 == paramFloat2 ? 0 : paramFloat1 > paramFloat2 ? 1 : paramFloat1 < paramFloat2 ? -1 : -1;
/*      */   }
/*      */   
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/nio/FloatBuffer.class
