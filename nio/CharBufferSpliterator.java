...
/*    */   {
/* 57 */     int i = this.index;int j = i + this.limit >>> 1;
...
/* 67 */     CharBuffer localCharBuffer = this.buffer;
/* 68 */     int i = this.index;
/* 69 */     int j = this.limit;
/* 70 */     this.index = j;
/* 71 */     while (i < j) {
/* 72 */       paramIntConsumer.accept(localCharBuffer.getUnchecked(i++));
/*    */     }
/*    */   }
/*    */   
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/nio/CharBufferSpliterator.class
