...
/*     */   {
/* 103 */     return new HeapCharBuffer(this.hb, -1, 0, remaining(), remaining(), position() + this.offset);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 111 */     return new HeapCharBuffer(this.hb, markValue(), position(), limit(), capacity(), this.offset);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 121 */     return new HeapCharBufferR(this.hb, markValue(), position(), limit(), capacity(), this.offset);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 203 */       HeapCharBuffer localHeapCharBuffer = (HeapCharBuffer)paramCharBuffer;
/* 204 */       int j = localHeapCharBuffer.remaining();
/* 205 */       if (j > remaining())
/* 206 */         throw new BufferOverflowException();
/* 207 */       System.arraycopy(localHeapCharBuffer.hb, localHeapCharBuffer.ix(localHeapCharBuffer.position()), this.hb, 
/* 208 */         ix(position()), j);
/* 209 */       localHeapCharBuffer.position(localHeapCharBuffer.position() + j);
...
/*     */   {
/* 577 */     if ((paramInt1 < 0) || 
/* 578 */       (paramInt2 > length()) || (paramInt1 > paramInt2))
/*     */     {
...
/*     */ 
/*     */ 
/* 586 */     return new HeapCharBuffer(this.hb, -1, i + paramInt1, i + paramInt2, capacity(), this.offset);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/nio/HeapCharBuffer.class
