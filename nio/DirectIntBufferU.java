...
/*     */   {
/* 221 */     return new DirectIntBufferU(this, markValue(), position(), limit(), capacity(), 0);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 231 */     return new DirectIntBufferRU(this, markValue(), position(), limit(), capacity(), 0);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 318 */       DirectIntBufferU localDirectIntBufferU = (DirectIntBufferU)paramIntBuffer;
/*     */       
/* 320 */       j = localDirectIntBufferU.position();
/* 321 */       k = localDirectIntBufferU.limit();
/* 322 */       assert (j <= k);
/* 323 */       int m = j <= k ? k - j : 0;
/*     */       
/* 325 */       int n = position();
...
/* 332 */       unsafe.copyMemory(localDirectIntBufferU.ix(j), ix(n), m << 2);
/* 333 */       localDirectIntBufferU.position(j + m);
/* 334 */       position(n + m);
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/nio/DirectIntBufferU.class
