...
/*     */   {
/* 103 */     return new HeapShortBuffer(this.hb, -1, 0, remaining(), remaining(), position() + this.offset);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 111 */     return new HeapShortBuffer(this.hb, markValue(), position(), limit(), capacity(), this.offset);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 121 */     return new HeapShortBufferR(this.hb, markValue(), position(), limit(), capacity(), this.offset);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 203 */       HeapShortBuffer localHeapShortBuffer = (HeapShortBuffer)paramShortBuffer;
/* 204 */       int j = localHeapShortBuffer.remaining();
/* 205 */       if (j > remaining())
/* 206 */         throw new BufferOverflowException();
/* 207 */       System.arraycopy(localHeapShortBuffer.hb, localHeapShortBuffer.ix(localHeapShortBuffer.position()), this.hb, 
/* 208 */         ix(position()), j);
/* 209 */       localHeapShortBuffer.position(localHeapShortBuffer.position() + j);
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/nio/HeapShortBuffer.class
