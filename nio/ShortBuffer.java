...
/* 1163 */       return false;
/* 1164 */     ShortBuffer localShortBuffer = (ShortBuffer)paramObject;
/* 1165 */     if (remaining() != localShortBuffer.remaining())
/* 1166 */       return false;
/* 1167 */     int i = position();
/* 1168 */     int j = limit() - 1; for (int k = localShortBuffer.limit() - 1; j >= i; k--) {
/* 1169 */       if (!equals(get(j), localShortBuffer.get(k))) {
/* 1170 */         return false;
/*      */       }
/* 1168 */       j--;
/*      */     }
...
/* 1207 */     int j = position(); for (int k = paramShortBuffer.position(); j < i; k++) {
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/nio/ShortBuffer.class
