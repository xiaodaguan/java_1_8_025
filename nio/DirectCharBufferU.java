...
/*     */   {
/* 221 */     return new DirectCharBufferU(this, markValue(), position(), limit(), capacity(), 0);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 231 */     return new DirectCharBufferRU(this, markValue(), position(), limit(), capacity(), 0);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 318 */       DirectCharBufferU localDirectCharBufferU = (DirectCharBufferU)paramCharBuffer;
/*     */       
/* 320 */       j = localDirectCharBufferU.position();
/* 321 */       k = localDirectCharBufferU.limit();
/* 322 */       assert (j <= k);
/* 323 */       int m = j <= k ? k - j : 0;
/*     */       
/* 325 */       int n = position();
...
/* 332 */       unsafe.copyMemory(localDirectCharBufferU.ix(j), ix(n), m << 1);
/* 333 */       localDirectCharBufferU.position(j + m);
/* 334 */       position(n + m);
...
/*     */ 
/*     */ 
/* 444 */     return new DirectCharBufferU(this, -1, i + paramInt1, i + paramInt2, capacity(), this.offset);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/nio/DirectCharBufferU.class
