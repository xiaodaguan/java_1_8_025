...
/*     */   {
/* 103 */     return new HeapByteBuffer(this.hb, -1, 0, remaining(), remaining(), position() + this.offset);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 111 */     return new HeapByteBuffer(this.hb, markValue(), position(), limit(), capacity(), this.offset);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 121 */     return new HeapByteBufferR(this.hb, markValue(), position(), limit(), capacity(), this.offset);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 203 */       HeapByteBuffer localHeapByteBuffer = (HeapByteBuffer)paramByteBuffer;
/* 204 */       int j = localHeapByteBuffer.remaining();
/* 205 */       if (j > remaining())
/* 206 */         throw new BufferOverflowException();
/* 207 */       System.arraycopy(localHeapByteBuffer.hb, localHeapByteBuffer.ix(localHeapByteBuffer.position()), this.hb, 
/* 208 */         ix(position()), j);
/* 209 */       localHeapByteBuffer.position(localHeapByteBuffer.position() + j);
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/nio/HeapByteBuffer.class
