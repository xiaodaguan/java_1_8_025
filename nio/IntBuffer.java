...
/* 1163 */       return false;
/* 1164 */     IntBuffer localIntBuffer = (IntBuffer)paramObject;
/* 1165 */     if (remaining() != localIntBuffer.remaining())
/* 1166 */       return false;
/* 1167 */     int i = position();
/* 1168 */     int j = limit() - 1; for (int k = localIntBuffer.limit() - 1; j >= i; k--) {
/* 1169 */       if (!equals(get(j), localIntBuffer.get(k))) {
/* 1170 */         return false;
/*      */       }
/* 1168 */       j--;
/*      */     }
...
/* 1207 */     int j = position(); for (int k = paramIntBuffer.position(); j < i; k++) {
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/nio/IntBuffer.class
