...
/*  75 */     writeBits(localStringBuilder, paramSet.contains(PosixFilePermission.OWNER_READ), paramSet.contains(PosixFilePermission.OWNER_WRITE), paramSet
/*  76 */       .contains(PosixFilePermission.OWNER_EXECUTE));
/*  77 */     writeBits(localStringBuilder, paramSet.contains(PosixFilePermission.GROUP_READ), paramSet.contains(PosixFilePermission.GROUP_WRITE), paramSet
/*  78 */       .contains(PosixFilePermission.GROUP_EXECUTE));
/*  79 */     writeBits(localStringBuilder, paramSet.contains(PosixFilePermission.OTHERS_READ), paramSet.contains(PosixFilePermission.OTHERS_WRITE), paramSet
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/nio/file/attribute/PosixFilePermissions.class
