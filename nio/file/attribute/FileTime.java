...
/* 262 */         i = (int)Math.floorMod(this.value, 1000000000L);
/* 263 */         break;
...
/*     */   {
/* 291 */     return compareTo((FileTime)paramObject) == 0;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 416 */         l1 = this.unit.toSeconds(this.value);
/*     */       } else {
/* 418 */         l1 = toInstant().getEpochSecond();
/* 419 */         i = toInstant().getNano();
/*     */       }
/*     */       
/* 422 */       int j = 0;
/* 423 */       long l2; long l3; long l4; LocalDateTime localLocalDateTime; if (l1 >= -62167219200L)
/*     */       {
/* 425 */         l2 = l1 - 315569520000L + 62167219200L;
/* 426 */         l3 = Math.floorDiv(l2, 315569520000L) + 1L;
/* 427 */         l4 = Math.floorMod(l2, 315569520000L);
/* 428 */         localLocalDateTime = LocalDateTime.ofEpochSecond(l4 - 62167219200L, i, ZoneOffset.UTC);
/* 429 */         j = localLocalDateTime.getYear() + (int)l3 * 10000;
/*     */       }
/*     */       else {
/* 432 */         l2 = l1 + 62167219200L;
/* 433 */         l3 = l2 / 315569520000L;
/* 434 */         l4 = l2 % 315569520000L;
/* 435 */         localLocalDateTime = LocalDateTime.ofEpochSecond(l4 - 62167219200L, i, ZoneOffset.UTC);
/* 436 */         j = localLocalDateTime.getYear() + (int)l3 * 10000;
/*     */       }
/* 438 */       if (j <= 0) {
/* 439 */         j -= 1;
/*     */       }
/* 441 */       int k = localLocalDateTime.getNano();
/* 442 */       StringBuilder localStringBuilder = new StringBuilder(64);
/* 443 */       localStringBuilder.append(j < 0 ? "-" : "");
/* 444 */       j = Math.abs(j);
/* 445 */       if (j < 10000) {
/* 446 */         append(localStringBuilder, 1000, Math.abs(j));
/*     */       } else {
/* 448 */         localStringBuilder.append(String.valueOf(j));
/*     */       }
/* 450 */       localStringBuilder.append('-');
/* 451 */       append(localStringBuilder, 10, localLocalDateTime.getMonthValue());
/* 452 */       localStringBuilder.append('-');
/* 453 */       append(localStringBuilder, 10, localLocalDateTime.getDayOfMonth());
/* 454 */       localStringBuilder.append('T');
/* 455 */       append(localStringBuilder, 10, localLocalDateTime.getHour());
/* 456 */       localStringBuilder.append(':');
/* 457 */       append(localStringBuilder, 10, localLocalDateTime.getMinute());
/* 458 */       localStringBuilder.append(':');
/* 459 */       append(localStringBuilder, 10, localLocalDateTime.getSecond());
/* 460 */       if (k != 0) {
...
/* 466 */           m /= 10;
/*     */         }
/* 468 */         append(localStringBuilder, m, k);
/*     */       }
/* 470 */       localStringBuilder.append('Z');
/* 471 */       this.valueAsString = localStringBuilder.toString();
/*     */     }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/nio/file/attribute/FileTime.class
