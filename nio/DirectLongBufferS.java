...
/*     */   {
/* 221 */     return new DirectLongBufferS(this, markValue(), position(), limit(), capacity(), 0);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 231 */     return new DirectLongBufferRS(this, markValue(), position(), limit(), capacity(), 0);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 318 */       DirectLongBufferS localDirectLongBufferS = (DirectLongBufferS)paramLongBuffer;
/*     */       
/* 320 */       j = localDirectLongBufferS.position();
/* 321 */       k = localDirectLongBufferS.limit();
/* 322 */       assert (j <= k);
/* 323 */       int m = j <= k ? k - j : 0;
/*     */       
/* 325 */       int n = position();
...
/* 332 */       unsafe.copyMemory(localDirectLongBufferS.ix(j), ix(n), m << 3);
/* 333 */       localDirectLongBufferS.position(j + m);
/* 334 */       position(n + m);
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/nio/DirectLongBufferS.class
