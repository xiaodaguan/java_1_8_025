...
/* 1163 */       return false;
/* 1164 */     LongBuffer localLongBuffer = (LongBuffer)paramObject;
/* 1165 */     if (remaining() != localLongBuffer.remaining())
/* 1166 */       return false;
/* 1167 */     int i = position();
/* 1168 */     int j = limit() - 1; for (int k = localLongBuffer.limit() - 1; j >= i; k--) {
/* 1169 */       if (!equals(get(j), localLongBuffer.get(k))) {
/* 1170 */         return false;
/*      */       }
/* 1168 */       j--;
/*      */     }
...
/* 1207 */     int j = position(); for (int k = paramLongBuffer.position(); j < i; k++) {
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/nio/LongBuffer.class
