...
/* 198 */       long l = this.bits[j] ^ 0xFFFFFFFFFFFFFFFF;
/* 199 */       for (int k = 0; k < 64; k++) {
/* 200 */         if ((l & 1L) == 1L) {
/* 201 */           BigInteger localBigInteger = paramBigInteger.add(
/* 202 */             BigInteger.valueOf(i));
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/math/BitSieve.class
