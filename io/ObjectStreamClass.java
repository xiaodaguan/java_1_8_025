...
/*      */ 
/*      */ 
/*   84 */   private static final ReflectionFactory reflFactory = (ReflectionFactory)AccessController.doPrivileged(new ReflectionFactory.GetReflectionFactoryAction());
/*      */   private Class<?> cl;
/*      */   private String name;
/*      */   
...
/*      */   {
/*  306 */     return this.name + ": static final long serialVersionUID = " + getSerialVersionUID() + "L;";
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*  485 */             ObjectStreamClass.this.serializeEx = ObjectStreamClass.access$1102(ObjectStreamClass.this, new ObjectStreamClass.ExceptionInfo(localInvalidClassException.classname, localInvalidClassException
/*  486 */               .getMessage()));
...
/*      */     }
/*      */     catch (InvalidClassException localInvalidClassException) {
/*  520 */       throw new InternalError(localInvalidClassException);
/*      */     }
/*      */     
...
/*      */ 
/*      */ 
/*  613 */       if ((this.serializable == this.localDesc.serializable) && 
/*  614 */         (!paramClass.isArray()) && 
/*  615 */         (this.suid.longValue() != this.localDesc.getSerialVersionUID()))
/*      */       {
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*  621 */         throw new InvalidClassException(this.localDesc.name, "local class incompatible: stream classdesc serialVersionUID = " + this.suid + ", local class serialVersionUID = " + this.localDesc.getSerialVersionUID());
/*      */       }
/*      */       
...
/*      */       
/*  706 */       String str2 = (n == 76) || (n == 91) ? paramObjectInputStream.readTypeString() : new String(new char[] { n });
/*      */       try {
/*  708 */         this.fields[m] = new ObjectStreamField(str1, str2, false);
/*      */       }
/*      */       catch (RuntimeException localRuntimeException) {
/*  711 */         throw ((IOException)new InvalidClassException(this.name, "invalid descriptor for field " + str1).initCause(localRuntimeException));
/*      */       }
/*      */     }
...
/*  835 */         if ((paramClass == null) || ((paramClass == Object.class) && 
/*  836 */           (!localObjectStreamField.isPrimitive())))
/*      */         {
...
/*  970 */         throw new InternalError(localIllegalAccessException);
/*      */       }
/*      */     }
...
/*      */       catch (IllegalAccessException localIllegalAccessException)
/*      */       {
/*  998 */         throw new InternalError(localIllegalAccessException);
/*      */       }
/*      */     } else {
...
/*      */       catch (IllegalAccessException localIllegalAccessException)
/*      */       {
/* 1029 */         throw new InternalError(localIllegalAccessException);
/*      */       }
/*      */     } else {
...
/*      */       catch (IllegalAccessException localIllegalAccessException)
/*      */       {
/* 1057 */         throw new InternalError(localIllegalAccessException);
/*      */       }
/*      */     } else {
...
/* 1082 */         throw new InternalError(localThrowable);
/*      */       }
/*      */       catch (IllegalAccessException localIllegalAccessException)
/*      */       {
/* 1086 */         throw new InternalError(localIllegalAccessException);
/*      */       }
/*      */     }
...
/* 1111 */         throw new InternalError(localThrowable);
/*      */       }
/*      */       catch (IllegalAccessException localIllegalAccessException)
/*      */       {
/* 1115 */         throw new InternalError(localIllegalAccessException);
/*      */       }
/*      */     }
...
/* 1189 */           localArrayList.add(new ClassDataSlot(
/* 1190 */             lookup(localClass3, true), false));
/*      */         }
/* 1192 */         localClass1 = ((Class)localObject2).getSuperclass();
/*      */       }
/*      */       
/*      */ 
/* 1196 */       localArrayList.add(new ClassDataSlot(((ObjectStreamClass)localObject1).getVariantFor((Class)localObject2), true));
/*      */     }
/*      */     
/*      */ 
/* 1200 */     for (localObject1 = localClass1; localObject1 != localClass2; localObject1 = ((Class)localObject1).getSuperclass()) {
/* 1201 */       localArrayList.add(new ClassDataSlot(
/* 1202 */         lookup((Class)localObject1, true), false));
/*      */     }
/*      */     
/*      */ 
...
/* 1370 */       if ((i & 0x2) == 0) { if ((i & 0x5) == 0)
/*      */         {
/* 1372 */           if (packageEquals(paramClass, (Class)localObject)) {} }
/*      */       } else {
/* 1374 */         return null;
/*      */       }
...
/*      */   {
/* 1448 */     return (paramClass1.getClassLoader() == paramClass2.getClassLoader()) && (getPackageName(paramClass1).equals(getPackageName(paramClass2)));
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */ 
/*      */ 
/* 1555 */     if ((Serializable.class.isAssignableFrom(paramClass)) && 
/* 1556 */       (!Externalizable.class.isAssignableFrom(paramClass)) && 
/* 1557 */       (!Proxy.isProxyClass(paramClass)) && 
/* 1558 */       (!paramClass.isInterface()))
/*      */     {
...
/* 1616 */         if ((localField2.getType() == localObjectStreamField.getType()) && 
/* 1617 */           ((localField2.getModifiers() & 0x8) == 0))
/*      */         {
/*      */ 
/* 1620 */           arrayOfObjectStreamField2[j] = new ObjectStreamField(localField2, localObjectStreamField.isUnshared(), true);
/*      */         }
/*      */       }
/*      */       catch (NoSuchFieldException localNoSuchFieldException) {}
/* 1624 */       if (arrayOfObjectStreamField2[j] == null)
/*      */       {
/* 1626 */         arrayOfObjectStreamField2[j] = new ObjectStreamField(str, localObjectStreamField.getType(), localObjectStreamField.isUnshared());
/*      */       }
/*      */     }
...
/*      */     
/* 1650 */     return j == 0 ? NO_FIELDS : (ObjectStreamField[])localArrayList.toArray(new ObjectStreamField[j]);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/* 1694 */       if ((i & 0x200) != 0) {
/* 1695 */         i = arrayOfMethod.length > 0 ? i | 0x400 : i & 0xFBFF;
/*      */       }
/*      */       
/*      */ 
...
/* 1810 */       throw new InternalError(localIOException);
...
/* 1841 */       this.signature = ObjectStreamClass.getMethodSignature(paramConstructor
/* 1842 */         .getParameterTypes(), Void.TYPE);
/*      */     }
/*      */     
/*      */     public MemberSignature(Method paramMethod) {
/* 1846 */       this.member = paramMethod;
/* 1847 */       this.name = paramMethod.getName();
/* 1848 */       this.signature = ObjectStreamClass.getMethodSignature(paramMethod
/* 1849 */         .getParameterTypes(), paramMethod.getReturnType());
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/*      */   {
/* 1860 */     private static final Unsafe unsafe = ;
/*      */     
/*      */ 
...
/*      */         
/* 1899 */         long l = localField != null ? unsafe.objectFieldOffset(localField) : -1L;
...
/*      */         case 'Q': case 'R': case 'T': case 'U': case 'V': case 'W': case 'X': case 'Y': default: 
...
/* 2079 */             if ((localObject != null) && 
/* 2080 */               (!this.types[(i - this.numPrimFields)].isInstance(localObject)))
/*      */             {
...
/*      */ 
/*      */ 
/* 2089 */               throw new ClassCastException("cannot assign instance of " + localObject.getClass().getName() + " to field " + localField.getDeclaringClass().getName() + "." + localField.getName() + " of type " + localField.getType().getName() + " in instance of " + paramObject.getClass().getName());
/*      */             }
...
/*      */     
/* 2119 */     FieldReflectorKey localFieldReflectorKey = new FieldReflectorKey(localClass, paramArrayOfObjectStreamField, Caches.reflectorsQueue);
...
/*      */       }
/* 2153 */       ((EntryFuture)localObject2).set(localObject1);
...
/*      */         Class localClass;
/*      */         
/* 2209 */         return (this.nullClass ? localFieldReflectorKey.nullClass : ((localClass = (Class)get()) != null) && (localClass == localFieldReflectorKey.get())) && (this.sigs.equals(localFieldReflectorKey.sigs));
/*      */       }
/* 2211 */       return false;
/*      */     }
/*      */   }
...
/* 2251 */           if (((localObjectStreamField1.isPrimitive()) || (localObjectStreamField3.isPrimitive())) && 
/* 2252 */             (localObjectStreamField1.getTypeCode() != localObjectStreamField3.getTypeCode()))
/*      */           {
/*      */ 
/* 2255 */             throw new InvalidClassException(paramObjectStreamClass.name, "incompatible types for field " + localObjectStreamField1.getName());
/*      */           }
/* 2257 */           if (localObjectStreamField3.getField() != null)
/*      */           {
/* 2259 */             localObjectStreamField2 = new ObjectStreamField(localObjectStreamField3.getField(), localObjectStreamField3.isUnshared(), false);
/*      */           }
/*      */           else {
/* 2262 */             localObjectStreamField2 = new ObjectStreamField(localObjectStreamField3.getName(), localObjectStreamField3.getSignature(), localObjectStreamField3.isUnshared());
/*      */           }
/*      */         }
/*      */       }
/* 2266 */       if (localObjectStreamField2 == null)
/*      */       {
/* 2268 */         localObjectStreamField2 = new ObjectStreamField(localObjectStreamField1.getName(), localObjectStreamField1.getSignature(), false);
/*      */       }
...
/*      */         
/* 2331 */         return (localObject != null) && (localObject == ((WeakClassKey)paramObject).get());
/*      */       }
/* 2333 */       return false;
/*      */     }
/*      */   }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/io/ObjectStreamClass.class
