...
/*     */     
/*  42 */     this.colon = ((String)AccessController.doPrivileged(new GetPropertyAction("path.separator"))).charAt(0);
...
/* 156 */       Object localObject; if (useCanonPrefixCache)
/*     */       {
/*     */ 
/*     */ 
...
/* 174 */         if ((useCanonPrefixCache) && (str2 != null) && 
/* 175 */           (str2.startsWith(this.javaHome))) {
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/io/UnixFileSystem.class
