...
/*      */     throws UnsupportedEncodingException
/*      */   {
/*  175 */     this(paramBoolean, 
/*  176 */       (OutputStream)requireNonNull(paramOutputStream, "Null output stream"), 
/*  177 */       toCharset(paramString));
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*  966 */         ensureOpen();
/*  967 */         if ((this.formatter == null) || 
/*  968 */           (this.formatter.locale() != Locale.getDefault()))
...
/* 1023 */         ensureOpen();
/* 1024 */         if ((this.formatter == null) || 
/* 1025 */           (this.formatter.locale() != paramLocale))
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/io/PrintStream.class
