...
/*     */   
/*  94 */   private byte[] ctype = new byte['Ā'];
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */   {
/* 261 */     int i = this.ctype.length; for (;;) { i--; if (i < 0) break;
/* 262 */       this.ctype[i] = 0;
/*     */     }
/*     */   }
/*     */   
...
/* 279 */     for (; paramInt1 <= paramInt2; 
/* 280 */         tmp36_29[tmp36_33] = ((byte)(tmp36_29[tmp36_33] | 0x4))) {}
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 411 */       int tmp14_13 = i; byte[] tmp14_10 = this.ctype;tmp14_10[tmp14_13] = ((byte)(tmp14_10[tmp14_13] | 0x2)); }
/* 412 */     byte[] tmp32_27 = this.ctype;tmp32_27[46] = ((byte)(tmp32_27[46] | 0x2)); byte[] 
/* 413 */       tmp44_39 = this.ctype;tmp44_39[45] = ((byte)(tmp44_39[45] | 0x2));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 700 */       this.peekc = (m == this.ttype ? Integer.MAX_VALUE : m);
/*     */       
...
/* 825 */         arrayOfChar[0] = (arrayOfChar[2] = 39);
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/io/StreamTokenizer.class
