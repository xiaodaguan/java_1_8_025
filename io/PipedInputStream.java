...
/* 318 */         return -1;
/*     */       }
/* 320 */       if ((this.writeSide != null) && (!this.writeSide.isAlive())) { i--; if (i < 0) {
...
/*     */       }
/*     */     }
/* 331 */     int j = this.buffer[(this.out++)] & 0xFF;
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/io/PipedInputStream.class
