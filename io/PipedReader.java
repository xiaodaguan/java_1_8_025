...
/* 248 */         return -1;
/*     */       }
/* 250 */       if ((this.writeSide != null) && (!this.writeSide.isAlive())) { i--; if (i < 0) {
...
/*     */       }
/*     */     }
/* 261 */     int j = this.buffer[(this.out++)];
...
/* 313 */     int j = 1;
/* 314 */     while (this.in >= 0) { paramInt2--; if (paramInt2 <= 0) break;
/* 315 */       paramArrayOfChar[(paramInt1 + j)] = this.buffer[(this.out++)];
/* 316 */       j++;
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/io/PipedReader.class
