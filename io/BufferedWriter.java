...
/* 262 */         return;
/*     */       try {
/* 264 */         Writer localWriter = this.out;Object localObject1 = null;
/* 265 */         try { flushBuffer();
/*     */         }
/*     */         catch (Throwable localThrowable2)
/*     */         {
/* 264 */           localObject1 = localThrowable2;throw localThrowable2;
/*     */         } finally {
/* 266 */           if (localWriter != null) if (localObject1 != null) try { localWriter.close(); } catch (Throwable localThrowable3) { ((Throwable)localObject1).addSuppressed(localThrowable3); } else localWriter.close();
/* 267 */         } } finally { this.out = null;
/* 268 */         this.cb = null;
/*     */       }
/*     */     }
/*     */   }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/io/BufferedWriter.class
