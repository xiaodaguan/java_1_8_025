...
/*     */ 
/*     */ 
/*  79 */   private static final AtomicReferenceFieldUpdater<BufferedInputStream, byte[]> bufUpdater = AtomicReferenceFieldUpdater.newUpdater(BufferedInputStream.class, byte[].class, "buf");
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */     throws IOException
/*     */   {
/* 157 */     InputStream localInputStream = this.in;
/* 158 */     if (localInputStream == null)
/* 159 */       throw new IOException("Stream closed");
/* 160 */     return localInputStream;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     throws IOException
/*     */   {
/* 214 */     Object localObject = getBufIfOpen();
/* 215 */     if (this.markpos < 0) {
/* 216 */       this.pos = 0;
/* 217 */     } else if (this.pos >= localObject.length)
/* 218 */       if (this.markpos > 0) {
/* 219 */         i = this.pos - this.markpos;
/* 220 */         System.arraycopy(localObject, this.markpos, localObject, 0, i);
/* 221 */         this.pos = i;
/* 222 */         this.markpos = 0;
/* 223 */       } else if (localObject.length >= this.marklimit) {
/* 224 */         this.markpos = -1;
/* 225 */         this.pos = 0;
/* 226 */       } else { if (localObject.length >= MAX_BUFFER_SIZE) {
/* 227 */           throw new OutOfMemoryError("Required array size too large");
/*     */         }
/* 229 */         i = this.pos <= MAX_BUFFER_SIZE - this.pos ? this.pos * 2 : MAX_BUFFER_SIZE;
/*     */         
/* 231 */         if (i > this.marklimit)
/* 232 */           i = this.marklimit;
/* 233 */         byte[] arrayOfByte = new byte[i];
/* 234 */         System.arraycopy(localObject, 0, arrayOfByte, 0, this.pos);
/* 235 */         if (!bufUpdater.compareAndSet(this, localObject, arrayOfByte))
/*     */         {
/*     */ 
/*     */ 
/*     */ 
...
/*     */         }
/* 243 */         localObject = arrayOfByte;
/*     */       }
/* 245 */     this.count = this.pos;
/* 246 */     int i = getInIfOpen().read((byte[])localObject, this.pos, localObject.length - this.pos);
/* 247 */     if (i > 0) {
...
/* 350 */         return i;
/*     */       }
/* 352 */       InputStream localInputStream = this.in;
/* 353 */       if ((localInputStream != null) && (localInputStream.available() <= 0)) {
/* 354 */         return i;
/*     */       }
/*     */     }
/*     */   }
...
/* 480 */         InputStream localInputStream = this.in;
/* 481 */         this.in = null;
/* 482 */         if (localInputStream != null)
/* 483 */           localInputStream.close();
/* 484 */         return;
/*     */       }
/*     */     }
/*     */   }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/io/BufferedInputStream.class
