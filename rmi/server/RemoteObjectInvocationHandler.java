...
/* 166 */       if (paramObject != localObject) if (localObject == null) break label77;
/* 167 */       label77: return Boolean.valueOf(
/*     */       
/* 169 */         (Proxy.isProxyClass(localObject.getClass())) && 
/* 170 */         (equals(Proxy.getInvocationHandler(localObject))));
/*     */     }
...
/*     */       }
/*     */       
/* 194 */       return this.ref.invoke((Remote)paramObject, paramMethod, paramArrayOfObject, 
/* 195 */         getMethodHash(paramMethod));
/*     */     } catch (Exception localException) { UnexpectedException localUnexpectedException;
/* 197 */       if (!(localException instanceof RuntimeException)) {
/* 198 */         Class localClass1 = paramObject.getClass();
/*     */         try {
/* 200 */           paramMethod = localClass1.getMethod(paramMethod.getName(), paramMethod
/* 201 */             .getParameterTypes());
/*     */         }
/*     */         catch (NoSuchMethodException localNoSuchMethodException) {
/* 204 */           throw ((IllegalArgumentException)new IllegalArgumentException().initCause(localNoSuchMethodException));
/*     */         }
...
/*     */   {
/* 243 */     throw new InvalidObjectException("no data in stream; class: " + getClass().getName());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/rmi/server/RemoteObjectInvocationHandler.class
