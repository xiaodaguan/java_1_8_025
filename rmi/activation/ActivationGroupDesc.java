...
/*     */ 
/*     */ 
/* 284 */         return (this.command == null ? localCommandEnvironment.command == null : this.command.equals(localCommandEnvironment.command)) && (Arrays.equals(this.options, localCommandEnvironment.options));
/*     */       }
/* 286 */       return false;
/*     */     }
/*     */     
...
/*     */ 
/*     */ 
/* 343 */       return (this.className == null ? localActivationGroupDesc.className == null : this.className.equals(localActivationGroupDesc.className)) && (this.location == null ? localActivationGroupDesc.location == null : this.location.equals(localActivationGroupDesc.location)) && (this.data == null ? localActivationGroupDesc.data == null : this.data.equals(localActivationGroupDesc.data)) && (this.env == null ? localActivationGroupDesc.env == null : this.env.equals(localActivationGroupDesc.env)) && (this.props == null ? localActivationGroupDesc.props == null : this.props.equals(localActivationGroupDesc.props));
/*     */     }
/* 345 */     return false;
/*     */   }
/*     */   
...
/*     */   public int hashCode()
/*     */   {
/* 368 */     return (this.location == null ? 0 : this.location.hashCode() << 24) ^ (this.env == null ? 0 : this.env.hashCode() << 16) ^ (this.className == null ? 0 : this.className.hashCode() << 8) ^ (this.data == null ? 0 : this.data.hashCode());
/*     */   }
/*     */ }


/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/rmi/activation/ActivationGroupDesc.class
