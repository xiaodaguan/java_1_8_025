...
/*     */     }
/*     */     try {
/* 182 */       AccessController.doPrivileged(new PrivilegedExceptionAction()
/*     */       {
/*     */ 
/* 185 */         public Object run() throws Exception { return Statement.this.invokeInternal(); } }, localAccessControlContext);
/*     */ 
/*     */ 
/*     */     }
...
/*     */ 
/*     */ 
/* 276 */       if ((localObject1.getClass().isArray()) && (
/* 277 */         (str.equals("set")) || (str.equals("get")))) {
...
/*     */       {
/* 300 */         throw new Exception("Statement cannot invoke: " + str + " on " + localObject1.getClass(), localIllegalAccessException);
/*     */       }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/beans/Statement.class
