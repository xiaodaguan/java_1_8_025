...
/*     */   {
/* 101 */     if (paramBeanContext == this.beanContext) { return;
/*     */     }
/* 103 */     BeanContext localBeanContext1 = this.beanContext;
/* 104 */     BeanContext localBeanContext2 = paramBeanContext;
/*     */     
/* 106 */     if (!this.rejectedSetBCOnce) {
/* 107 */       if ((this.rejectedSetBCOnce = !validatePendingSetBeanContext(paramBeanContext) ? 1 : 0) != 0) {
/* 108 */         throw new PropertyVetoException("setBeanContext() change rejected:", new PropertyChangeEvent(this.beanContextChildPeer, "beanContext", localBeanContext1, localBeanContext2));
/*     */       }
/*     */       
/*     */ 
/*     */ 
/*     */       try
/*     */       {
/* 115 */         fireVetoableChange("beanContext", localBeanContext1, localBeanContext2);
/*     */ 
/*     */       }
...
/*     */         
/* 122 */         throw localPropertyVetoException;
/*     */       }
/*     */     }
/*     */     
/* 126 */     if (this.beanContext != null) { releaseBeanContextResources();
/*     */     }
/* 128 */     this.beanContext = localBeanContext2;
/* 129 */     this.rejectedSetBCOnce = false;
/*     */     
/* 131 */     firePropertyChange("beanContext", localBeanContext1, localBeanContext2);
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/beans/beancontext/BeanContextChildSupport.class
