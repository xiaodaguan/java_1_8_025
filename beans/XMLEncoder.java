...
/*     */     }
/* 340 */     return (List<Statement>)localObject;
/*     */   }
/*     */   
...
/* 619 */         writeln("<object class=" + quote(((Field)localObject2).getDeclaringClass().getName()) + " field=" + 
/* 620 */           quote(((Field)localObject2).getName()) + "/>");
/* 621 */         return;
/*     */       }
/*     */       
/* 624 */       Object localObject2 = primitiveTypeFor(paramObject1.getClass());
/* 625 */       if ((localObject2 != null) && (localObject1 == paramObject1.getClass()) && 
/* 626 */         (str1.equals("new"))) {
...
/*     */     
/*     */ 
/* 755 */     if ((i != 0) || (!str1.equals("set")) || (arrayOfObject.length != 2) || (!(arrayOfObject[0] instanceof Integer))) { if (i != 0)
/*     */       {
/* 757 */         if ((!str1.equals("get")) || (arrayOfObject.length != 1) || (!(arrayOfObject[0] instanceof Integer))) {} }
/*     */     } else {
...
/*     */       break label711; }
/* 762 */     if (((i == 0) && (str1.startsWith("set")) && (arrayOfObject.length == 1)) || ((i != 0) && 
/* 763 */       (str1.startsWith("get")) && (arrayOfObject.length == 0))) {
...
/*     */     
/* 778 */     if ((paramVarArgs.length == 0) && (localList.size() == 0)) {
...
/*     */     
/* 786 */     for (int i = 0; i < paramVarArgs.length; i++) {
/* 787 */       outputValue(paramVarArgs[i], null, true);
/*     */     }
/*     */     
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/beans/XMLEncoder.class
