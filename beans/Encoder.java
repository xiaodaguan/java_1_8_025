...
/*     */   {
/* 247 */     if ((paramObject == null) || (paramObject == this) || 
/* 248 */       (paramObject.getClass() == String.class)) {
...
/*     */     
/*     */ 
/* 275 */     Expression localExpression = Statement.class.equals(paramStatement.getClass()) ? new Statement(localObject2, paramStatement.getMethodName(), arrayOfObject2) : new Expression(localObject2, paramStatement.getMethodName(), arrayOfObject2);
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/beans/Encoder.class
