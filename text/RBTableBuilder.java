...
/* 144 */           addExpandOrder(str2, str1, k); } else { char c;
...
/*     */     case 0: 
/* 297 */       paramInt2 += 65536;
/* 298 */       paramInt2 &= 0xFFFF0000;
/* 299 */       this.isOverIgnore = true;
/* 300 */       break;
/*     */     
/*     */     case 1: 
/* 303 */       paramInt2 += 256;
/* 304 */       paramInt2 &= 0xFF00;
/*     */       
/* 306 */       if (!this.isOverIgnore) {
/* 307 */         this.maxSecOrder = ((short)(this.maxSecOrder + 1));
/*     */       }
/*     */       break;
/*     */     case 2: 
/* 311 */       paramInt2++;
...
/* 385 */     EntryPair localEntryPair; if (k != -1) {
...
/*     */       } else {
/* 399 */         localVector.insertElementAt(new EntryPair(paramString, paramInt, paramBoolean), localVector
/* 400 */           .size() - 1);
/*     */       }
/*     */     }
/*     */     
...
/* 533 */         k++; char c; if ((k == paramString.length()) || 
/* 534 */           (!Character.isLowSurrogate(c = paramString.charAt(k)))) {
/*     */           break;
/*     */         }
/*     */         
/*     */ 
...
/*     */       
/* 577 */       char c2 = Character.isHighSurrogate(c1) ? Character.toCodePoint(c1, paramString.charAt(++j)) : c1;
/*     */       
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/text/RBTableBuilder.class
