...
/*     */ 
/*     */ 
/* 224 */   private transient byte[] statusArray = new byte[' '];
...
/*     */     throws ParseException
/*     */   {
/* 242 */     if ((this.lastEntry != null) && (paramPatternEntry.chars.equals(this.lastEntry.chars)) && 
/* 243 */       (paramPatternEntry.extension.equals(this.lastEntry.extension))) {
...
/*     */         
/* 316 */         if ((this.statusArray[j] & '\001' << (paramPatternEntry.chars.charAt(0) & 0x7)) != 0) {
...
/* 330 */       if (localPatternEntry.chars.regionMatches(0, paramPatternEntry.chars, 0, localPatternEntry.chars
/* 331 */         .length())) {
/* 332 */         paramStringBuffer.append(paramPatternEntry.chars.substring(localPatternEntry.chars.length(), paramPatternEntry.chars
/* 333 */           .length()));
/* 334 */         break;
/*     */       }
/*     */     }
...
/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/text/MergeCollation.class
