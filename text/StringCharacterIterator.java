...
/* 243 */       return false;
/*     */     }
/* 245 */     StringCharacterIterator localStringCharacterIterator = (StringCharacterIterator)paramObject;
/*     */     
/* 247 */     if (hashCode() != localStringCharacterIterator.hashCode())
/* 248 */       return false;
/* 249 */     if (!this.text.equals(localStringCharacterIterator.text))
/* 250 */       return false;
/* 251 */     if ((this.pos != localStringCharacterIterator.pos) || (this.begin != localStringCharacterIterator.begin) || (this.end != localStringCharacterIterator.end))
/* 252 */       return false;
/* 253 */     return true;
/*     */   }
/*     */   
...
/*     */     try
/*     */     {
/* 273 */       return (StringCharacterIterator)super.clone();
/*     */     }
/*     */     catch (CloneNotSupportedException localCloneNotSupportedException)
/*     */     {
/* 277 */       throw new InternalError(localCloneNotSupportedException);
/*     */     }
/*     */   }
/*     */ }


/* Location:              /Users/guanxiaoda/Documents/workspace/rt.jar!/java/text/StringCharacterIterator.class
